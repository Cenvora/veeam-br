...
class LinuxFlrMountSpec:
    ...
    Attributes:
        ...
        mount_server (LinuxFlrMountServerSettings): Mount server settings for file restore from Linux machines. Specify
            exactly one of `mountServerId`, `helperHost`, `helperAppliance`, or `originalHost` according to the value of
            `mountServerType`.
    ...
    mount_server: LinuxFlrMountServerSettings
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mount_server = LinuxFlrMountServerSettings.from_dict(d.pop("mountServer"))
