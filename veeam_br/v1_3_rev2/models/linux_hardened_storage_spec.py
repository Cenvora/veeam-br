...
T = TypeVar("T", bound="LinuxHardenedStorageSpec")


@_attrs_define
class LinuxHardenedStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_hardened_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
            host_id=host_id,
        ...
        linux_hardened_storage_spec.additional_properties = d
        return linux_hardened_storage_spec
