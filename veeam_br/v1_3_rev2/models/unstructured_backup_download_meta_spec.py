...
class UnstructuredBackupDownloadMetaSpec:
    ...
    Attributes:
        target_repository_id (UUID | Unset): ID of the repository where the backup metadata will be stored. Must be
            omitted for Direct to object storage backup with fixed cache repository. Required otherwise.
