...
T = TypeVar("T", bound="EntraIDTenantBackupCopyJobModel")


@_attrs_define
class EntraIDTenantBackupCopyJobModel:
    """Microsoft Entra ID tenant backup copy job.

    Attributes:
        id (UUID): Job ID.
        name (str): Name of the job.
        type_ (EJobType): Type of the job.
        primary_job_id (UUID): Primary job ID.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_backup_copy_job_model = cls(
            id=id,
            name=name,
            type_=type_,
        ...
        entra_id_tenant_backup_copy_job_model.additional_properties = d
        return entra_id_tenant_backup_copy_job_model
