...
class CredentialsFilters:
    ...
    Attributes:
        ...
        include_default_appliance_creds (bool | Unset): If `true`, default appliance credentials will be included in the
            response.
        include_hidden_creds (bool | Unset): If `true`, hidden credentials will be included in the response. Default:
            True.
        type_filter (list[ECredentialsType] | Unset): Filters credentials by type. Multiple values may be specified to
            match any of them.
    ...
    type_filter: list[ECredentialsType] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _type_filter is not UNSET:
            ...
            for type_filter_item_data in _type_filter:
                type_filter_item = ECredentialsType(type_filter_item_data)
