...
if TYPE_CHECKING:
    from ..models.google_cloud_storage_account_model import GoogleCloudStorageAccountModel
...
T = TypeVar("T", bound="GoogleCloudStorageSpec")


@_attrs_define
class GoogleCloudStorageSpec:
    ...
    Attributes:
        ...
        account (GoogleCloudStorageAccountModel): Account used to access the Google Cloud storage.
    ...
    account: GoogleCloudStorageAccountModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account = GoogleCloudStorageAccountModel.from_dict(d.pop("account"))
        ...
        google_cloud_storage_spec.additional_properties = d
        return google_cloud_storage_spec
