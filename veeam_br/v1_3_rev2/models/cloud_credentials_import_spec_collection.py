...
class CloudCredentialsImportSpecCollection:
    """Array of settings for cloud credential import.

    Attributes:
        azure_storage (list[AzureStorageCloudCredentialsImportSpec] | Unset): Array of Microsoft Azure storage accounts.
        azure_compute (list[AzureComputeCloudCredentialsImportSpec] | Unset): Array of Microsoft Azure compute accounts.
