...
T = TypeVar("T", bound="LinuxMountServerFlrMountServerSettings")


@_attrs_define
class LinuxMountServerFlrMountServerSettings:
    """Mount server settings for file restore from Linux machines when `mountServerType` is `MountServer`.

    Attributes:
        mount_server_type (EFlrMountModeServerType): Mount server mode.
        mount_server_id (UUID): Mount server ID.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_mount_server_flr_mount_server_settings = cls(
            mount_server_type=mount_server_type,
            mount_server_id=mount_server_id,
        )

        linux_mount_server_flr_mount_server_settings.additional_properties = d
        return linux_mount_server_flr_mount_server_settings
