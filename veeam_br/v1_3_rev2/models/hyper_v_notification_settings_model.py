...
T = TypeVar("T", bound="HyperVNotificationSettingsModel")


@_attrs_define
class HyperVNotificationSettingsModel:
    """Notification settings for Hyper-V backup jobs.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hyper_v_notification_settings_model = cls(
            send_snmp_notifications=send_snmp_notifications,
            email_notifications=email_notifications,
        )

        hyper_v_notification_settings_model.additional_properties = d
        return hyper_v_notification_settings_model
