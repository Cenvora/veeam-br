...
from ..models.e_power_state import EPowerState
...
class VmwareObjectModel:
    ...
    Attributes:
        ...
        power_state (EPowerState | Unset): Power state of the virtual machine.
    ...
    urn: str | Unset = UNSET
    power_state: EPowerState | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        power_state: EPowerState | Unset
        if isinstance(_power_state, Unset):
            power_state = UNSET
        else:
            power_state = EPowerState(_power_state)
