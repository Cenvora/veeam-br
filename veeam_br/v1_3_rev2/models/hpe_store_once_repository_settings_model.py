...
T = TypeVar("T", bound="HPEStoreOnceRepositorySettingsModel")


@_attrs_define
class HPEStoreOnceRepositorySettingsModel:
    """HPE StoreOnce repository settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hpe_store_once_repository_settings_model = cls(
            path=path,
        ...
        hpe_store_once_repository_settings_model.additional_properties = d
        return hpe_store_once_repository_settings_model
