...
if TYPE_CHECKING:
    ...
    from ..models.v_sphere_replica_job_virtual_machines_model import VSphereReplicaJobVirtualMachinesModel
    from ..models.v_sphere_replica_seeding_model import VSphereReplicaSeedingModel


T = TypeVar("T", bound="VSphereReplicaJobModel")


@_attrs_define
class VSphereReplicaJobModel:
    ...
    Attributes:
        ...
        virtual_machines (VSphereReplicaJobVirtualMachinesModel): Included and excluded objects.
        ...
        network (list[VSphereReplicaJobNetworkMappingModel] | Unset): Array of mapping rules for networks. Mapping rules
            are used if destination site networks do not match your production site networks.
    ...
    type_: EJobType
    description: str
    virtual_machines: VSphereReplicaJobVirtualMachinesModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virtual_machines = VSphereReplicaJobVirtualMachinesModel.from_dict(d.pop("virtualMachines"))
        ...
        v_sphere_replica_job_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        v_sphere_replica_job_model.additional_properties = d
        return v_sphere_replica_job_model
