...
from ..models.e_entra_id_tenant_credentials_type import EEntraIdTenantCredentialsType
...
class EntraIDTenantModel:
    ...
    Attributes:
        ...
        name (str | Unset): Tenant name.
        credentials_type (EEntraIdTenantCredentialsType | Unset): Credentials type.
    """
    ...
    credentials_type: EEntraIdTenantCredentialsType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credentials_type: EEntraIdTenantCredentialsType | Unset
        if isinstance(_credentials_type, Unset):
            credentials_type = UNSET
        else:
            credentials_type = EEntraIdTenantCredentialsType(_credentials_type)
