...
T = TypeVar("T", bound="ProxmoxBackupObjectModel")


@_attrs_define
class ProxmoxBackupObjectModel:
    """Proxmox VE backup object.
    ...
    Attributes:
        ...
        object_id (None | str | Unset): Native ID of the Proxmox VE virtual machine.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        proxmox_backup_object_model = cls(
            id=id,
        ...
        proxmox_backup_object_model.additional_properties = d
        return proxmox_backup_object_model
