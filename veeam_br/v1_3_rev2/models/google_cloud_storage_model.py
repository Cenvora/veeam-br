...
T = TypeVar("T", bound="GoogleCloudStorageModel")


@_attrs_define
class GoogleCloudStorageModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_cloud_storage_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        google_cloud_storage_model.additional_properties = d
