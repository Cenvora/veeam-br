...
if TYPE_CHECKING:
    ...
    from ..models.embedded_recovery_media_state_model import EmbeddedRecoveryMediaStateModel
...
class DiscoveredComputerEntityModel:
    ...
    Attributes:
        ...
        embedded_recovery_media_state (EmbeddedRecoveryMediaStateModel | Unset): Details of Embedded Recovery Media of a
            host.
    """
    ...
    embedded_recovery_media_state: EmbeddedRecoveryMediaStateModel | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        embedded_recovery_media_state: dict[str, Any] | Unset = UNSET
        if not isinstance(self.embedded_recovery_media_state, Unset):
            embedded_recovery_media_state = self.embedded_recovery_media_state.to_dict()
        ...
        if embedded_recovery_media_state is not UNSET:
            field_dict["embeddedRecoveryMediaState"] = embedded_recovery_media_state
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _embedded_recovery_media_state = d.pop("embeddedRecoveryMediaState", UNSET)
        embedded_recovery_media_state: EmbeddedRecoveryMediaStateModel | Unset
        if isinstance(_embedded_recovery_media_state, Unset):
            embedded_recovery_media_state = UNSET
        else:
            embedded_recovery_media_state = EmbeddedRecoveryMediaStateModel.from_dict(_embedded_recovery_media_state)
        ...
        discovered_computer_entity_model = cls(
            ...
            bios_uuid=bios_uuid,
            embedded_recovery_media_state=embedded_recovery_media_state,
        )
