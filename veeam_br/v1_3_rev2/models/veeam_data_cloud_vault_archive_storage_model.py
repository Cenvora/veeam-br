...
T = TypeVar("T", bound="VeeamDataCloudVaultArchiveStorageModel")


@_attrs_define
class VeeamDataCloudVaultArchiveStorageModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        veeam_data_cloud_vault_archive_storage_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        veeam_data_cloud_vault_archive_storage_model.additional_properties = d
        return veeam_data_cloud_vault_archive_storage_model
