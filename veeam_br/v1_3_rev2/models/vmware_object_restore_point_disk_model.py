...
T = TypeVar("T", bound="VmwareObjectRestorePointDiskModel")


@_attrs_define
class VmwareObjectRestorePointDiskModel:
    """VMware vSphere disk.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vmware_object_restore_point_disk_model = cls(
            platform=platform,
            uid=uid,
            type_=type_,
            name=name,
        ...
        vmware_object_restore_point_disk_model.additional_properties = d
        return vmware_object_restore_point_disk_model
