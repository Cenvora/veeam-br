...
class LinuxLocalRepositorySettingsModel:
    ...
    Attributes:
        ...
        enable_governance_mode (bool | Unset): If `true`, governance mode is enabled for immutability.
        governance_mode_retention_days (int | Unset): Number of days to keep backups immutable when governance mode is
            enabled.
    ...
    enable_governance_mode: bool | Unset = UNSET
    governance_mode_retention_days: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        enable_governance_mode = self.enable_governance_mode

        governance_mode_retention_days = self.governance_mode_retention_days
        ...
        if enable_governance_mode is not UNSET:
            field_dict["enableGovernanceMode"] = enable_governance_mode
        if governance_mode_retention_days is not UNSET:
            field_dict["governanceModeRetentionDays"] = governance_mode_retention_days
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enable_governance_mode = d.pop("enableGovernanceMode", UNSET)

        governance_mode_retention_days = d.pop("governanceModeRetentionDays", UNSET)
        ...
        linux_local_repository_settings_model = cls(
            ...
            enable_governance_mode=enable_governance_mode,
            governance_mode_retention_days=governance_mode_retention_days,
