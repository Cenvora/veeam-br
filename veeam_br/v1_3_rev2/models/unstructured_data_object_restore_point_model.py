...
T = TypeVar("T", bound="UnstructuredDataObjectRestorePointModel")


@_attrs_define
class UnstructuredDataObjectRestorePointModel:
    """Unstructured data restore point.
    ...
    Attributes:
        ...
        file_size (int | Unset): Size, in bytes, of the requested file at this restore point.
        file_modification_date (datetime.datetime | Unset): Last modification date of the requested file at this restore
            point.
    """
    ...
    file_modification_date: datetime.datetime | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        file_modification_date: str | Unset = UNSET
        if not isinstance(self.file_modification_date, Unset):
            file_modification_date = self.file_modification_date.isoformat()
        ...
        if file_modification_date is not UNSET:
            field_dict["fileModificationDate"] = file_modification_date
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _file_modification_date = d.pop("fileModificationDate", UNSET)
        file_modification_date: datetime.datetime | Unset
        if isinstance(_file_modification_date, Unset):
            file_modification_date = UNSET
        else:
            file_modification_date = isoparse(_file_modification_date)

        unstructured_data_object_restore_point_model = cls(
            id=id,
            name=name,
        ...
        unstructured_data_object_restore_point_model.additional_properties = d
        return unstructured_data_object_restore_point_model
