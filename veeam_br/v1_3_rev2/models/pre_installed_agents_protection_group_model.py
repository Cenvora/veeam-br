...
T = TypeVar("T", bound="PreInstalledAgentsProtectionGroupModel")


@_attrs_define
class PreInstalledAgentsProtectionGroupModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pre_installed_agents_protection_group_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        pre_installed_agents_protection_group_model.additional_properties = d
        return pre_installed_agents_protection_group_model
