...
T = TypeVar("T", bound="ExaGridStorageSpec")


@_attrs_define
class ExaGridStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        exa_grid_storage_spec.additional_properties = d
        return exa_grid_storage_spec
