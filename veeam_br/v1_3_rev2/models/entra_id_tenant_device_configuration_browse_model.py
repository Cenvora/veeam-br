...
class EntraIdTenantDeviceConfigurationBrowseModel:
    ...
    Attributes:
        ...
        odata_type (str | Unset): OData type of the device configuration.
        device_configuration_type (EEntraIdTenantDeviceConfigurationType | Unset): Device configuration type.
    """
    ...
    odata_type: str | Unset = UNSET
    device_configuration_type: EEntraIdTenantDeviceConfigurationType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        device_configuration_type: str | Unset = UNSET
        if not isinstance(self.device_configuration_type, Unset):
            device_configuration_type = self.device_configuration_type.value
        ...
        if odata_type is not UNSET:
            field_dict["odataType"] = odata_type
        if device_configuration_type is not UNSET:
            field_dict["deviceConfigurationType"] = device_configuration_type
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        odata_type = d.pop("odataType", UNSET)

        _device_configuration_type = d.pop("deviceConfigurationType", UNSET)
        device_configuration_type: EEntraIdTenantDeviceConfigurationType | Unset
        if isinstance(_device_configuration_type, Unset):
            device_configuration_type = UNSET
        else:
            device_configuration_type = EEntraIdTenantDeviceConfigurationType(_device_configuration_type)
        ...
        entra_id_tenant_device_configuration_browse_model = cls(
            ...
            device_configuration_type=device_configuration_type,
        )
