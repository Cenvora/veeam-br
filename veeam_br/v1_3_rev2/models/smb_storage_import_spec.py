...
if TYPE_CHECKING:
    ...
    from ..models.smb_repository_share_settings_spec import SmbRepositoryShareSettingsSpec


T = TypeVar("T", bound="SmbStorageImportSpec")


@_attrs_define
class SmbStorageImportSpec:
    """Import settings for SMB shares.
    ...
    Attributes:
        ...
        share (SmbRepositoryShareSettingsSpec): SMB share settings.
    ...
    share: SmbRepositoryShareSettingsSpec
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        share = SmbRepositoryShareSettingsSpec.from_dict(d.pop("share"))
        ...
        smb_storage_import_spec.additional_properties = d
        return smb_storage_import_spec
