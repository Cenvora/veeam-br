...
T = TypeVar("T", bound="ReplicasFilters")


@_attrs_define
class ReplicasFilters:
    """
    Attributes:
        skip (int | Unset):
        limit (int | Unset):
        ...
        policy_unique_id_filter (str | Unset):
        state_filter (EReplicaState | Unset): Replica state.
    """
    ...
    policy_unique_id_filter: str | Unset = UNSET
    state_filter: EReplicaState | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        policy_unique_id_filter = self.policy_unique_id_filter
        ...
        if policy_unique_id_filter is not UNSET:
            field_dict["policyUniqueIdFilter"] = policy_unique_id_filter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_order_column, Unset):
            ...
            order_column = EReplicasFiltersOrderColumn(_order_column)
        ...
        policy_unique_id_filter = d.pop("policyUniqueIdFilter", UNSET)

        _state_filter = d.pop("stateFilter", UNSET)
        state_filter: EReplicaState | Unset
        if isinstance(_state_filter, Unset):
            state_filter = UNSET
        else:
            state_filter = EReplicaState(_state_filter)

        replicas_filters = cls(
            skip=skip,
            limit=limit,
            ...
            policy_unique_id_filter=policy_unique_id_filter,
            state_filter=state_filter,
        )

        replicas_filters.additional_properties = d
        return replicas_filters
