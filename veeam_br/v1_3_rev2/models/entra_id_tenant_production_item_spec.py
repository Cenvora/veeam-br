...
class EntraIdTenantProductionItemSpec:
    """Microsoft Entra ID item that you want to check.

    Attributes:
        item_id (str): Item ID. To get the ID, run the [Get Restore Points of Microsoft Entra ID Tenant](Backup-
            Browser#operation/BrowseEntraIdTenantBackupRestorePoints)
