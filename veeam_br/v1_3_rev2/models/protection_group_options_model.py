...
class ProtectionGroupOptionsModel:
    ...
    Attributes:
        ...
        install_no_snap_agent (bool | Unset): If `true`, the distribution server will deploy agents in no-snap mode to
            the discovered computers in the protection group.
    ...
    install_no_snap_agent: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        install_no_snap_agent = self.install_no_snap_agent
        ...
        if install_no_snap_agent is not UNSET:
            field_dict["installNoSnapAgent"] = install_no_snap_agent
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_no_snap_agent = d.pop("installNoSnapAgent", UNSET)
        ...
        protection_group_options_model = cls(
            ...
            install_no_snap_agent=install_no_snap_agent,
