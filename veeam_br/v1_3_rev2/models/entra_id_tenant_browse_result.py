...
class EntraIdTenantBrowseResult:
    """Details on Microsoft Entra ID items.

    Attributes:
        data (list[EntraIdTenantBrowseModel]): Array of Microsoft Entra ID items. To get the IDs, run the [Get Restore
            Points of Microsoft Entra ID Tenant](Backup-Browser#operation/BrowseEntraIdTenantBackupRestorePoints)
        pagination (PaginationResult): Pagination settings.
    """

    data: list[EntraIdTenantBrowseModel]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = EntraIdTenantBrowseModel.from_dict(data_item_data)
