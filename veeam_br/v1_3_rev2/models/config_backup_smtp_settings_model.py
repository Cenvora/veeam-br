...
T = TypeVar("T", bound="ConfigBackupSMTPSettingsModel")


@_attrs_define
class ConfigBackupSMTPSettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_backup_smtp_settings_model = cls(
        ...
        config_backup_smtp_settings_model.additional_properties = d
        return config_backup_smtp_settings_model
