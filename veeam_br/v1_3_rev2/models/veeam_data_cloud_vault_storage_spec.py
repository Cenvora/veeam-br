...
T = TypeVar("T", bound="VeeamDataCloudVaultStorageSpec")


@_attrs_define
class VeeamDataCloudVaultStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        veeam_data_cloud_vault_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
            account=account,
        ...
        veeam_data_cloud_vault_storage_spec.additional_properties = d
        return veeam_data_cloud_vault_storage_spec
