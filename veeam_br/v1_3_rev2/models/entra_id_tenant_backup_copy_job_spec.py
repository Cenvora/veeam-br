...
T = TypeVar("T", bound="EntraIDTenantBackupCopyJobSpec")


@_attrs_define
class EntraIDTenantBackupCopyJobSpec:
    """Settings for Microsoft Entra ID tenant backup copy job.

    Attributes:
        name (str): Name of the job.
        type_ (EJobType): Type of the job.
        primary_job_id (UUID): Primary job ID. To get the ID, run the [Get All Jobs](Jobs#operation/GetAllJobs) request.
        ...
        use_custom_retention (bool | Unset): If `true`, the backup copy job uses custom retention settings.
        retention_policy (FileBackupRetentionPolicySettingsModel | Unset): Retention policy settings.
        use_custom_encryption (bool | Unset): If `true`, the backup copy job uses custom encryption settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_backup_copy_job_spec = cls(
            name=name,
            type_=type_,
        ...
        entra_id_tenant_backup_copy_job_spec.additional_properties = d
        return entra_id_tenant_backup_copy_job_spec
