...
if TYPE_CHECKING:
    from ..models.veeam_data_cloud_archive_storage_container_model import VeeamDataCloudArchiveStorageContainerModel
    from ..models.veeam_data_cloud_storage_account_model import VeeamDataCloudStorageAccountModel


T = TypeVar("T", bound="VeeamDataCloudVaultArchiveStorageSpec")


@_attrs_define
class VeeamDataCloudVaultArchiveStorageSpec:
    """Settings for Veeam Data Cloud Vault Archive.
    ...
    Attributes:
        ...
        container (VeeamDataCloudArchiveStorageContainerModel): Veeam Data Cloud Archive container.
    ...
    container: VeeamDataCloudArchiveStorageContainerModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        container = VeeamDataCloudArchiveStorageContainerModel.from_dict(d.pop("container"))
        ...
        veeam_data_cloud_vault_archive_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
            account=account,
        ...
        veeam_data_cloud_vault_archive_storage_spec.additional_properties = d
        return veeam_data_cloud_vault_archive_storage_spec
