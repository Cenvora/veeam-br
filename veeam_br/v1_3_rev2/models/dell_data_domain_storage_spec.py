...
T = TypeVar("T", bound="DellDataDomainStorageSpec")


@_attrs_define
class DellDataDomainStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dell_data_domain_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
        ...
        dell_data_domain_storage_spec.additional_properties = d
        return dell_data_domain_storage_spec
