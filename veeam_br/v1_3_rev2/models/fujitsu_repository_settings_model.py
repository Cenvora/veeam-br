...
T = TypeVar("T", bound="FujitsuRepositorySettingsModel")


@_attrs_define
class FujitsuRepositorySettingsModel:
    """Fujitsu ETERNUS CS800 repository settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fujitsu_repository_settings_model = cls(
            path=path,
        ...
        fujitsu_repository_settings_model.additional_properties = d
        return fujitsu_repository_settings_model
