...
if TYPE_CHECKING:
    from ..models.file_backup_job_advanced_settings_model import FileBackupJobAdvancedSettingsModel
...
T = TypeVar("T", bound="FileBackupJobPrimaryRepositoryModel")


@_attrs_define
class FileBackupJobPrimaryRepositoryModel:
    """Primary backup repository for file share backup job.
    ...
    Attributes:
        ...
        advanced_settings (FileBackupJobAdvancedSettingsModel | Unset): Advanced settings for file share backup job.
    """
    ...
    advanced_settings: FileBackupJobAdvancedSettingsModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_settings: FileBackupJobAdvancedSettingsModel | Unset
        if isinstance(_advanced_settings, Unset):
            advanced_settings = UNSET
        else:
            advanced_settings = FileBackupJobAdvancedSettingsModel.from_dict(_advanced_settings)

        file_backup_job_primary_repository_model = cls(
        ...
        file_backup_job_primary_repository_model.additional_properties = d
        return file_backup_job_primary_repository_model
