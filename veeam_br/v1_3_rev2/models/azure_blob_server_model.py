...
class AzureBlobServerModel:
    ...
    Attributes:
        ...
        credentials_id (UUID): ID of the credentials used to access your Microsoft Azure Blob storage.
        region_type (EAzureRegionType | Unset): Microsoft Azure region.
        region_display_name (str | Unset): Display name of a region where the storage is located.
        processing (AzureBlobServerProcessingModel | Unset): Processing settings for Microsoft Azure Blob storage.
    """
    ...
    region_display_name: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region_display_name = d.pop("regionDisplayName", UNSET)
