...
if TYPE_CHECKING:
    ...
    from ..models.wasabi_cloud_storage_account_model import WasabiCloudStorageAccountModel
    from ..models.wasabi_cloud_storage_bucket_model import WasabiCloudStorageBucketModel


T = TypeVar("T", bound="WasabiCloudStorageModel")


@_attrs_define
class WasabiCloudStorageModel:
    ...
    Attributes:
        ...
        account (WasabiCloudStorageAccountModel): Account used to access the Wasabi Cloud storage.
    ...
    account: WasabiCloudStorageAccountModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account = WasabiCloudStorageAccountModel.from_dict(d.pop("account"))
        ...
        wasabi_cloud_storage_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        wasabi_cloud_storage_model.additional_properties = d
        return wasabi_cloud_storage_model
