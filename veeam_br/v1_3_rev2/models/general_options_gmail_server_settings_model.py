...
T = TypeVar("T", bound="GeneralOptionsGmailServerSettingsModel")


@_attrs_define
class GeneralOptionsGmailServerSettingsModel:
    """Google Gmail server settings.

    Attributes:
        notifications_enabled (bool): If `true`, email notifications are enabled and the `emailSettings` property is
        ...
        is_default_app (bool | Unset): If `true`, the built-in Veeam application is used instead of a custom registered
            application.
    """
    ...
    is_default_app: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_default_app = self.is_default_app
        ...
        if is_default_app is not UNSET:
            field_dict["isDefaultApp"] = is_default_app
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_default_app = d.pop("isDefaultApp", UNSET)

        general_options_gmail_server_settings_model = cls(
        ...
        general_options_gmail_server_settings_model.additional_properties = d
        return general_options_gmail_server_settings_model
