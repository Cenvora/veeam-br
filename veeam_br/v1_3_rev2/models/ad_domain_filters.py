...
T = TypeVar("T", bound="ADDomainFilters")
...
class ADDomainFilters:
    ...
    Attributes:
        ...
        order_asc (bool | Unset): If `true`, sorts Active Directory domains in ascending order by the `orderColumn`
            parameter.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_order_column, Unset):
            ...
            order_column = EADDomainFiltersOrderColumn(_order_column)

        order_asc = d.pop("orderAsc", UNSET)

        name_filter = d.pop("nameFilter", UNSET)

        ad_domain_filters = cls(
            skip=skip,
            limit=limit,
        ...
        ad_domain_filters.additional_properties = d
        return ad_domain_filters
