...
if TYPE_CHECKING:
    ...
    from ..models.instant_vi_vm_customized_recovery_destination_spec import InstantViVMCustomizedRecoveryDestinationSpec
    from ..models.secure_restore_spec import SecureRestoreSpec


T = TypeVar("T", bound="InstantViVMCustomizedRecoverySpec")


@_attrs_define
class InstantViVMCustomizedRecoverySpec:
    ...
    Attributes:
        ...
        destination (InstantViVMCustomizedRecoveryDestinationSpec | Unset): Destination where the recovered VM resides.
            To get objects of the destination host, folder and resource pool, run the [Get Inventory Objects](Inventory-
            Browser#operation/GetInventoryObjects) request.
    ...
    destination: InstantViVMCustomizedRecoveryDestinationSpec | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.instant_vi_vm_customized_recovery_datastore_spec import InstantViVMCustomizedRecoveryDatastoreSpec
        from ..models.instant_vi_vm_customized_recovery_destination_spec import (
        ...
        destination: InstantViVMCustomizedRecoveryDestinationSpec | Unset
        if isinstance(_destination, Unset):
            destination = UNSET
        else:
            destination = InstantViVMCustomizedRecoveryDestinationSpec.from_dict(_destination)

        vm_tags_restore_enabled = d.pop("vmTagsRestoreEnabled", UNSET)

        instant_vi_vm_customized_recovery_spec = cls(
        ...
        instant_vi_vm_customized_recovery_spec.additional_properties = d
        return instant_vi_vm_customized_recovery_spec
