...
T = TypeVar("T", bound="InstantViVMOriginalLocationRecoverySpec")


@_attrs_define
class InstantViVMOriginalLocationRecoverySpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instant_vi_vm_original_location_recovery_spec = cls(
        ...
        instant_vi_vm_original_location_recovery_spec.additional_properties = d
        return instant_vi_vm_original_location_recovery_spec
