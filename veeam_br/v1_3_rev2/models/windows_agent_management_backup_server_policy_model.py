...
T = TypeVar("T", bound="WindowsAgentManagementBackupServerPolicyModel")


@_attrs_define
class WindowsAgentManagementBackupServerPolicyModel:
    """Backup policy settings for Veeam Agent for Microsoft Windows. The settings apply to the `server` protected computer
    type.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_agent_management_backup_server_policy_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        windows_agent_management_backup_server_policy_model.additional_properties = d
        return windows_agent_management_backup_server_policy_model
