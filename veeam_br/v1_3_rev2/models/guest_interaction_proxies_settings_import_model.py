...
class GuestInteractionProxiesSettingsImportModel:
    ...
    Attributes:
        automatic_selection (bool): If `true`, Veeam Backup & Replication automatically selects the guest interaction
            proxy. Default: True.
        proxies (list[str] | Unset): Array of proxies specified explicitly. The array must contain servers registered as
            guest interaction proxies in the backup infrastructure.
    """
