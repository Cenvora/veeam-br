...
T = TypeVar("T", bound="QuantumDXiStorageModel")


@_attrs_define
class QuantumDXiStorageModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quantum_d_xi_storage_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        quantum_d_xi_storage_model.additional_properties = d
        return quantum_d_xi_storage_model
