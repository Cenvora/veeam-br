...
class ProtectionGroupAdvancedWindowsSettingsModel:
    ...
    Attributes:
        ...
        create_embedded_recovery_media (bool | Unset): If `true`, enables Embedded Recovery Media creation.
    """
    ...
    create_embedded_recovery_media: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        create_embedded_recovery_media = self.create_embedded_recovery_media
        ...
        if create_embedded_recovery_media is not UNSET:
            field_dict["createEmbeddedRecoveryMedia"] = create_embedded_recovery_media
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_embedded_recovery_media = d.pop("createEmbeddedRecoveryMedia", UNSET)
        ...
        protection_group_advanced_windows_settings_model = cls(
            ...
            create_embedded_recovery_media=create_embedded_recovery_media,
        )
