...
T = TypeVar("T", bound="InfinidatStorageSpec")


@_attrs_define
class InfinidatStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        infinidat_storage_spec.additional_properties = d
        return infinidat_storage_spec
