...
if TYPE_CHECKING:
    from ..models.azure_compute_network_security_group_model import AzureComputeNetworkSecurityGroupModel
...
class AzureComputeNetworkModel:
    ...
    Attributes:
        ...
        network_security_group (AzureComputeNetworkSecurityGroupModel): Security group settings for the recovered
            workload.
    ...
    network: str
    subnet: str
    network_security_group: AzureComputeNetworkSecurityGroupModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_security_group = AzureComputeNetworkSecurityGroupModel.from_dict(d.pop("networkSecurityGroup"))
