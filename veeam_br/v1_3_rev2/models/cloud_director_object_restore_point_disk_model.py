...
T = TypeVar("T", bound="CloudDirectorObjectRestorePointDiskModel")


@_attrs_define
class CloudDirectorObjectRestorePointDiskModel:
    """VMware Cloud Director disk.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_director_object_restore_point_disk_model = cls(
            platform=platform,
            uid=uid,
            type_=type_,
            name=name,
        ...
        cloud_director_object_restore_point_disk_model.additional_properties = d
        return cloud_director_object_restore_point_disk_model
