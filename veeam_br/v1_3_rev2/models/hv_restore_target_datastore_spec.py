...
class HvRestoreTargetDatastoreSpec:
    ...
    Attributes:
        disk (HyperVDiskExtentModel): Disk extent of Microsoft Hyper-V host.
        target_folder (str): Absolute path to the folder, where the disk must be placed in the target datastore.
    """
