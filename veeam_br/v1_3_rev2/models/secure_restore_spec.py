...
class SecureRestoreSpec:
    ...
    Attributes:
        antivirus_scan_enabled (bool | Unset): If `true`, Veeam Backup & Replication scans machine data with antivirus
            software before restoring the machine to the production environment.
        yara_scan_enabled (bool | Unset): If `true`, Veeam Backup & Replication scans machine data with a YARA rule
            before restoring the machine to the production environment.
        yara_rule (str | Unset): Name of the YARA rule used to scan machine data.
    ...
    antivirus_scan_enabled: bool | Unset = UNSET
    yara_scan_enabled: bool | Unset = UNSET
    yara_rule: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if antivirus_scan_enabled is not UNSET:
            field_dict["antivirusScanEnabled"] = antivirus_scan_enabled
        if yara_scan_enabled is not UNSET:
            field_dict["yaraScanEnabled"] = yara_scan_enabled
        if yara_rule is not UNSET:
            field_dict["yaraRule"] = yara_rule
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        antivirus_scan_enabled = d.pop("antivirusScanEnabled", UNSET)

        yara_scan_enabled = d.pop("yaraScanEnabled", UNSET)

        yara_rule = d.pop("yaraRule", UNSET)
