...
T = TypeVar("T", bound="ManuallyAddedProtectionGroupModel")


@_attrs_define
class ManuallyAddedProtectionGroupModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        manually_added_protection_group_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        manually_added_protection_group_model.additional_properties = d
        return manually_added_protection_group_model
