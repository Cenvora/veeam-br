...
T = TypeVar("T", bound="IBMCloudStorageSpec")


@_attrs_define
class IBMCloudStorageSpec:
    """IBM Cloud storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ibm_cloud_storage_spec.additional_properties = d
        return ibm_cloud_storage_spec
