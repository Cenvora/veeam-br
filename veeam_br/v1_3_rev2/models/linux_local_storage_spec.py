...
T = TypeVar("T", bound="LinuxLocalStorageSpec")


@_attrs_define
class LinuxLocalStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_local_storage_spec.additional_properties = d
        return linux_local_storage_spec
