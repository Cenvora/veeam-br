...
T = TypeVar("T", bound="AmazonSnowballEdgeStorageSpec")


@_attrs_define
class AmazonSnowballEdgeStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        amazon_snowball_edge_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
            account=account,
        ...
        amazon_snowball_edge_storage_spec.additional_properties = d
        return amazon_snowball_edge_storage_spec
