...
if TYPE_CHECKING:
    ...
    from ..models.backup_schedule_model_daily import BackupScheduleModelDaily
...
T = TypeVar("T", bound="LinuxAgentManagementBackupWorkstationPolicyModel")


@_attrs_define
class LinuxAgentManagementBackupWorkstationPolicyModel:
    """Backup policy settings for Veeam Agent for Linux. The settings apply to the `workstation` protected computer type.
    ...
    Attributes:
        ...
        schedule (BackupScheduleModelDaily | Unset): Job scheduling options - Daily.
    """
    ...
    schedule: BackupScheduleModelDaily | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule: BackupScheduleModelDaily | Unset
        if isinstance(_schedule, Unset):
            schedule = UNSET
        else:
            schedule = BackupScheduleModelDaily.from_dict(_schedule)

        linux_agent_management_backup_workstation_policy_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        linux_agent_management_backup_workstation_policy_model.additional_properties = d
        return linux_agent_management_backup_workstation_policy_model
