...
class InstalledLicenseModel:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_multi_section = self.is_multi_section
        ...
        field_dict.update(
            {
                ...
                "IsMultiSection": is_multi_section,
                "proactiveSupportEnabled": proactive_support_enabled,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_multi_section = d.pop("IsMultiSection")
