...
if TYPE_CHECKING:
    from ..models.exa_grid_repository_settings_model import ExaGridRepositorySettingsModel
    from ..models.mount_servers_settings_model import MountServersSettingsModel


T = TypeVar("T", bound="ExaGridStorageModel")


@_attrs_define
class ExaGridStorageModel:
    """ExaGrid deduplication appliance repository.
    ...
    Attributes:
        ...
        repository (ExaGridRepositorySettingsModel): ExaGrid repository settings.
    ...
    host_id: UUID
    repository: ExaGridRepositorySettingsModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repository = ExaGridRepositorySettingsModel.from_dict(d.pop("repository"))
        ...
        exa_grid_storage_model.additional_properties = d
        return exa_grid_storage_model
