...
T = TypeVar("T", bound="InstantHvVMRecoveryHelperApplianceSpec")


@_attrs_define
class InstantHvVMRecoveryHelperApplianceSpec:
    """Helper appliance.

    Attributes:
        production_network (HyperVObjectModel): Microsoft Hyper-V object.
        vlan_id (int | Unset): ID of the VLAN used by the helper appliance.
    ...
    production_network: HyperVObjectModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        production_network = HyperVObjectModel.from_dict(d.pop("productionNetwork"))
        ...
        instant_hv_vm_recovery_helper_appliance_spec = cls(
        ...
        instant_hv_vm_recovery_helper_appliance_spec.additional_properties = d
        return instant_hv_vm_recovery_helper_appliance_spec
