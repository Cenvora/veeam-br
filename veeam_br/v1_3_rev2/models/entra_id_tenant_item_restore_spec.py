...
from ..models.e_entra_id_reference_restore_mode import EEntraIdReferenceRestoreMode
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.entra_id_item_include_restore_spec import EntraIDItemIncludeRestoreSpec
    from ..models.entra_id_tenant_restore_application_certificates_spec import (
        EntraIdTenantRestoreApplicationCertificatesSpec,
    )
...
class EntraIdTenantItemRestoreSpec:
    ...
    Attributes:
        ...
        users_passwords (list[EntraIdTenantRestoreUserPasswordSpec] | Unset): Array of custom user passwords. To
            ...
            Browser#operation/GenerateEntraIdTenantPassword) request.
        application_certificates (list[EntraIdTenantRestoreApplicationCertificatesSpec] | Unset): Array of application
            certificates.
        reason (str | Unset): Reason for restoring Microsoft Entra ID items.
        reference_restore_mode (EEntraIdReferenceRestoreMode | Unset): Object relation restore mode.
    """
    ...
    application_certificates: list[EntraIdTenantRestoreApplicationCertificatesSpec] | Unset = UNSET
    reason: str | Unset = UNSET
    reference_restore_mode: EEntraIdReferenceRestoreMode | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        application_certificates: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.application_certificates, Unset):
            application_certificates = []
            for application_certificates_item_data in self.application_certificates:
                application_certificates_item = application_certificates_item_data.to_dict()
                application_certificates.append(application_certificates_item)

        reason = self.reason

        reference_restore_mode: str | Unset = UNSET
        if not isinstance(self.reference_restore_mode, Unset):
            reference_restore_mode = self.reference_restore_mode.value
        ...
        if application_certificates is not UNSET:
            field_dict["applicationCertificates"] = application_certificates
        if reason is not UNSET:
            field_dict["reason"] = reason
        if reference_restore_mode is not UNSET:
            field_dict["referenceRestoreMode"] = reference_restore_mode
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _application_certificates = d.pop("applicationCertificates", UNSET)
        application_certificates: list[EntraIdTenantRestoreApplicationCertificatesSpec] | Unset = UNSET
        if _application_certificates is not UNSET:
            application_certificates = []
            for application_certificates_item_data in _application_certificates:
                application_certificates_item = EntraIdTenantRestoreApplicationCertificatesSpec.from_dict(
                    application_certificates_item_data
                )
        ...
        _reference_restore_mode = d.pop("referenceRestoreMode", UNSET)
        reference_restore_mode: EEntraIdReferenceRestoreMode | Unset
        if isinstance(_reference_restore_mode, Unset):
            reference_restore_mode = UNSET
        else:
            reference_restore_mode = EEntraIdReferenceRestoreMode(_reference_restore_mode)
        ...
        entra_id_tenant_item_restore_spec = cls(
            ...
            application_certificates=application_certificates,
            reason=reason,
            reference_restore_mode=reference_restore_mode,
        )
