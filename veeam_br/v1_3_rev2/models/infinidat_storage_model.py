...
if TYPE_CHECKING:
    from ..models.infinidat_repository_settings_model import InfinidatRepositorySettingsModel
    from ..models.mount_servers_settings_model import MountServersSettingsModel


T = TypeVar("T", bound="InfinidatStorageModel")


@_attrs_define
class InfinidatStorageModel:
    """Infinidat InfiniGuard deduplication appliance repository.
    ...
    Attributes:
        ...
        repository (InfinidatRepositorySettingsModel): Infinidat InfiniGuard repository settings.
    ...
    host_id: UUID
    repository: InfinidatRepositorySettingsModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repository = InfinidatRepositorySettingsModel.from_dict(d.pop("repository"))
        ...
        infinidat_storage_model.additional_properties = d
        return infinidat_storage_model
