...
if TYPE_CHECKING:
    from ..models.ibm_cloud_storage_account_import_model import IBMCloudStorageAccountImportModel
    from ..models.ibm_cloud_storage_bucket_model import IBMCloudStorageBucketModel
...
T = TypeVar("T", bound="IBMCloudStorageImportSpec")


@_attrs_define
class IBMCloudStorageImportSpec:
    """Import settings for IBM cloud storage.
    ...
    Attributes:
        ...
        account (IBMCloudStorageAccountImportModel): Account used to access the IBM Cloud storage.
        bucket (IBMCloudStorageBucketModel): IBM Cloud bucket where backup data is stored.
    ...
    account: IBMCloudStorageAccountImportModel
    bucket: IBMCloudStorageBucketModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account = IBMCloudStorageAccountImportModel.from_dict(d.pop("account"))

        bucket = IBMCloudStorageBucketModel.from_dict(d.pop("bucket"))
        ...
        ibm_cloud_storage_import_spec = cls(
            name=name,
            description=description,
            unique_id=unique_id,
            type_=type_,
        ...
        ibm_cloud_storage_import_spec.additional_properties = d
        return ibm_cloud_storage_import_spec
