...
T = TypeVar("T", bound="AzureBlobStorageModel")
...
class AzureBlobStorageModel:
    ...
    Attributes:
        ...
        account (AzureBlobStorageAccountModel): Account used to access the Microsoft Azure Blob storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_blob_storage_model.additional_properties = d
        return azure_blob_storage_model
