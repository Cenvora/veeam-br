...
T = TypeVar("T", bound="HyperVBackupScopeModel")


@_attrs_define
class HyperVBackupScopeModel:
    """Microsoft Hyper-V backup scope.

    Attributes:
        type_ (EInventoryScopeWorkloadType): Workload type.
        inventory_objects (list[HyperVObjectModel] | Unset): Array of Microsoft Hyper-V inventory objects.
    """

    type_: EInventoryScopeWorkloadType
    inventory_objects: list[HyperVObjectModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _inventory_objects is not UNSET:
            ...
            for inventory_objects_item_data in _inventory_objects:
                inventory_objects_item = HyperVObjectModel.from_dict(inventory_objects_item_data)

                inventory_objects.append(inventory_objects_item)

        hyper_v_backup_scope_model = cls(
            type_=type_,
            inventory_objects=inventory_objects,
        )

        hyper_v_backup_scope_model.additional_properties = d
        return hyper_v_backup_scope_model
