...
T = TypeVar("T", bound="AzureComputeBackupObjectModel")


@_attrs_define
class AzureComputeBackupObjectModel:
    """Microsoft Azure Compute backup object.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_compute_backup_object_model = cls(
            id=id,
        ...
        azure_compute_backup_object_model.additional_properties = d
        return azure_compute_backup_object_model
