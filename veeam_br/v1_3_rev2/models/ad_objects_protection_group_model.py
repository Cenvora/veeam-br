...
T = TypeVar("T", bound="ADObjectsProtectionGroupModel")


@_attrs_define
class ADObjectsProtectionGroupModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ad_objects_protection_group_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        ad_objects_protection_group_model.additional_properties = d
        return ad_objects_protection_group_model
