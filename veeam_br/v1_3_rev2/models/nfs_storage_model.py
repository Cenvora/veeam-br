...
if TYPE_CHECKING:
    ...
    from ..models.nfs_repository_share_settings_model import NfsRepositoryShareSettingsModel
    from ..models.repository_import_options import RepositoryImportOptions


T = TypeVar("T", bound="NfsStorageModel")


@_attrs_define
class NfsStorageModel:
    ...
    Attributes:
        ...
        share (NfsRepositoryShareSettingsModel): NFS share settings.
    ...
    share: NfsRepositoryShareSettingsModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        share = NfsRepositoryShareSettingsModel.from_dict(d.pop("share"))
        ...
        nfs_storage_model.additional_properties = d
        return nfs_storage_model
