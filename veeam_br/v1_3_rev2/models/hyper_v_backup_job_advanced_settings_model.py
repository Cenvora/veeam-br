...
if TYPE_CHECKING:
    ...
    from ..models.hyper_v_notification_settings_model import HyperVNotificationSettingsModel
...
class HyperVBackupJobAdvancedSettingsModel:
    ...
    Attributes:
        ...
        synthetic_fulls (SyntheticFullSettingsModel | Unset): Synthetic full backup settings.
        ...
        notifications (HyperVNotificationSettingsModel | Unset): Notification settings for Hyper-V backup jobs.
    ...
    synthetic_fulls: SyntheticFullSettingsModel | Unset = UNSET
    ...
    notifications: HyperVNotificationSettingsModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        synthetic_fulls: SyntheticFullSettingsModel | Unset
        if isinstance(_synthetic_fulls, Unset):
            synthetic_fulls = UNSET
        else:
            synthetic_fulls = SyntheticFullSettingsModel.from_dict(_synthetic_fulls)
        ...
        notifications: HyperVNotificationSettingsModel | Unset
        if isinstance(_notifications, Unset):
            notifications = UNSET
        else:
            notifications = HyperVNotificationSettingsModel.from_dict(_notifications)
