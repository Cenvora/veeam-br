...
from ..models.e_unix_package_filters_order_column import EUnixPackageFiltersOrderColumn
from ..types import UNSET, Unset

T = TypeVar("T", bound="UnixPackageFilters")
...
class UnixPackageFilters:
    ...
    Attributes:
        ...
        order_asc (bool | Unset): If `true`, sorts Unix packages in ascending order by the `orderColumn` parameter.
        name_filter (str | Unset): Filters Unix packages by the `nameFilter` pattern. The pattern can match any Unix
            package parameter. To substitute one or more characters, use the asterisk (*) character at the beginning and/or
            at the end.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_order_column, Unset):
            ...
            order_column = EUnixPackageFiltersOrderColumn(_order_column)

        order_asc = d.pop("orderAsc", UNSET)

        name_filter = d.pop("nameFilter", UNSET)

        unix_package_filters = cls(
            skip=skip,
            limit=limit,
        ...
        unix_package_filters.additional_properties = d
        return unix_package_filters
