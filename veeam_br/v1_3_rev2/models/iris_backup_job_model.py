...
T = TypeVar("T", bound="IrisBackupJobModel")


@_attrs_define
class IrisBackupJobModel:
    """InterSystems IRIS backup job.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        iris_backup_job_model.additional_properties = d
        return iris_backup_job_model
