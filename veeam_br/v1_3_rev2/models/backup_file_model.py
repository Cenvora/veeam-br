...
class BackupFileModel:
    ...
    Attributes:
        ...
        object_ids (list[UUID]): Array of IDs of the backup objects associated with the backup file.
        ...
        severity (ESuspiciousActivitySeverity | Unset): Malware status.
    """
    ...
    severity: ESuspiciousActivitySeverity | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        severity: ESuspiciousActivitySeverity | Unset
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = ESuspiciousActivitySeverity(_severity)
