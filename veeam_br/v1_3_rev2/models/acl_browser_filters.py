...
T = TypeVar("T", bound="AclBrowserFilters")


@_attrs_define
class AclBrowserFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acl_browser_filters = cls(
            pagination=pagination,
            filter_=filter_,
            sorting=sorting,
        )

        acl_browser_filters.additional_properties = d
        return acl_browser_filters
