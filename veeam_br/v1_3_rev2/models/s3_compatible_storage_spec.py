...
T = TypeVar("T", bound="S3CompatibleStorageSpec")


@_attrs_define
class S3CompatibleStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        s3_compatible_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
            account=account,
        ...
        s3_compatible_storage_spec.additional_properties = d
        return s3_compatible_storage_spec
