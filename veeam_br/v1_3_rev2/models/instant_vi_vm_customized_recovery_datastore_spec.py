...
class InstantViVMCustomizedRecoveryDatastoreSpec:
    ...
    object, run the [Get Inventory Objects](Inventory-Browser#operation/GetInventoryObjects) request.
        ...
        Attributes:
            redirect_enabled (bool | Unset): If `true`, redo logs are redirected to `cacheDatastore`.
            cache_datastore (InventoryObjectModel | Unset): Inventory object properties.
    """

    redirect_enabled: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if redirect_enabled is not UNSET:
            field_dict["redirectEnabled"] = redirect_enabled
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        redirect_enabled = d.pop("redirectEnabled", UNSET)
