...
T = TypeVar("T", bound="HPEStoreOnceStorageSpec")


@_attrs_define
class HPEStoreOnceStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hpe_store_once_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
        ...
        hpe_store_once_storage_spec.additional_properties = d
        return hpe_store_once_storage_spec
