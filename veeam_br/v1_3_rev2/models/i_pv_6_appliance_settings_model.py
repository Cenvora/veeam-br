...
T = TypeVar("T", bound="IPv6ApplianceSettingsModel")


@_attrs_define
class IPv6ApplianceSettingsModel:
    """IPv6 address settings.

    Attributes:
        obtain_ip_automatically (bool | Unset): If `true`, the IPv6 address is obtained automatically.
        obtain_dns_automatically (bool | Unset): If `true`, the DNS server address is obtained automatically.
        ip_address (IPv6SettingsModel | Unset): IPv6 settings.
    """

    obtain_ip_automatically: bool | Unset = UNSET
    obtain_dns_automatically: bool | Unset = UNSET
    ip_address: IPv6SettingsModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_address: IPv6SettingsModel | Unset
        if isinstance(_ip_address, Unset):
            ip_address = UNSET
        else:
            ip_address = IPv6SettingsModel.from_dict(_ip_address)

        i_pv_6_appliance_settings_model = cls(
            obtain_ip_automatically=obtain_ip_automatically,
            obtain_dns_automatically=obtain_dns_automatically,
            ip_address=ip_address,
        )

        i_pv_6_appliance_settings_model.additional_properties = d
        return i_pv_6_appliance_settings_model
