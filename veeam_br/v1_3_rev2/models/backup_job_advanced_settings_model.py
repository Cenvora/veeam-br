...
class BackupJobAdvancedSettingsModel:
    ...
    Attributes:
        ...
        storage_integration (PrimaryStorageIntegrationSettingsModel | Unset): Primary storage integration settings for
            the job.
    ...
    storage_integration: PrimaryStorageIntegrationSettingsModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage_integration: PrimaryStorageIntegrationSettingsModel | Unset
