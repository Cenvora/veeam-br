...
T = TypeVar("T", bound="NutanixBackupObjectModel")


@_attrs_define
class NutanixBackupObjectModel:
    """Nutanix AHV backup object.
    ...
    Attributes:
        ...
        object_id (None | str | Unset): Native ID of the Nutanix AHV virtual machine.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nutanix_backup_object_model = cls(
            id=id,
        ...
        nutanix_backup_object_model.additional_properties = d
        return nutanix_backup_object_model
