...
if TYPE_CHECKING:
    from ..models.config_backup_smtp_settings_model import ConfigBackupSMTPSettingsModel
...
class ConfigBackupNotificationsModel:
    ...
    Attributes:
        ...
        smtp_settings (ConfigBackupSMTPSettingsModel | Unset): Email notification settings.
    """

    snmp_enabled: bool
    smtp_settings: ConfigBackupSMTPSettingsModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smtp_settings: ConfigBackupSMTPSettingsModel | Unset
        if isinstance(_smtp_settings, Unset):
            smtp_settings = UNSET
        else:
            smtp_settings = ConfigBackupSMTPSettingsModel.from_dict(_smtp_settings)
