...
T = TypeVar("T", bound="InstantHvVMOriginalLocationRecoverySpec")


@_attrs_define
class InstantHvVMOriginalLocationRecoverySpec:
    """Instant Recovery to the original location with initial settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instant_hv_vm_original_location_recovery_spec = cls(
        ...
        instant_hv_vm_original_location_recovery_spec.additional_properties = d
        return instant_hv_vm_original_location_recovery_spec
