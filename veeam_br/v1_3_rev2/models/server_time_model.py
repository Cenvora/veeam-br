...
class ServerTimeModel:
    ...
    Attributes:
        ...
        iana_time_zone_id (str | Unset): IANA time zone identifier for the backup server (for example, `Europe/Prague`).
            Suitable for DST-aware date/time formatting on the client. May be omitted if the server cannot resolve the local
            time zone to an IANA identifier.
    """

    server_time: datetime.datetime
    time_zone: str | Unset = UNSET
    iana_time_zone_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        iana_time_zone_id = self.iana_time_zone_id
        ...
        if iana_time_zone_id is not UNSET:
            field_dict["ianaTimeZoneId"] = iana_time_zone_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        iana_time_zone_id = d.pop("ianaTimeZoneId", UNSET)
