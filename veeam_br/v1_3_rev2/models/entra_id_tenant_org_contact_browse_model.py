...
T = TypeVar("T", bound="EntraIdTenantOrgContactBrowseModel")


@_attrs_define
class EntraIdTenantOrgContactBrowseModel:
    """Microsoft Entra ID organizational contact.
    ...
    Attributes:
        ...
        department (str | Unset): Department.
        job_title (str | Unset): Job title.
        mail (str | Unset): Email address.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_org_contact_browse_model = cls(
            id=id,
            type_=type_,
        ...
        entra_id_tenant_org_contact_browse_model.additional_properties = d
        return entra_id_tenant_org_contact_browse_model
