...
T = TypeVar("T", bound="EntraIdTenantBackupScopeModel")


@_attrs_define
class EntraIdTenantBackupScopeModel:
    """Microsoft Entra ID tenant backup scope.

    Attributes:
        type_ (EInventoryScopeWorkloadType): Workload type.
        inventory_objects (list[EntraIDTenantModel] | Unset): Array of Microsoft Entra ID tenant inventory objects.
    """

    type_: EInventoryScopeWorkloadType
    inventory_objects: list[EntraIDTenantModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _inventory_objects is not UNSET:
            ...
            for inventory_objects_item_data in _inventory_objects:
                inventory_objects_item = EntraIDTenantModel.from_dict(inventory_objects_item_data)

                inventory_objects.append(inventory_objects_item)

        entra_id_tenant_backup_scope_model = cls(
            type_=type_,
            inventory_objects=inventory_objects,
        )

        entra_id_tenant_backup_scope_model.additional_properties = d
        return entra_id_tenant_backup_scope_model
