...
T = TypeVar("T", bound="ExaGridRepositorySettingsModel")


@_attrs_define
class ExaGridRepositorySettingsModel:
    """ExaGrid repository settings.
    ...
    Attributes:
        ...
        max_task_count (int | Unset): Maximum number of concurrent tasks. Default: 10.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        exa_grid_repository_settings_model = cls(
            path=path,
        ...
        exa_grid_repository_settings_model.additional_properties = d
        return exa_grid_repository_settings_model
