...
T = TypeVar("T", bound="FujitsuStorageSpec")


@_attrs_define
class FujitsuStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fujitsu_storage_spec.additional_properties = d
        return fujitsu_storage_spec
