...
T = TypeVar("T", bound="IrisProtectionGroupSpec")


@_attrs_define
class IrisProtectionGroupSpec:
    """Settings of InterSystems IRIS protection group.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        iris_protection_group_spec = cls(
            name=name,
            description=description,
            type_=type_,
            servers=servers,
        ...
        iris_protection_group_spec.additional_properties = d
        return iris_protection_group_spec
