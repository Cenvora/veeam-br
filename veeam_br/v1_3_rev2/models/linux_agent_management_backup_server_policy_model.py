...
T = TypeVar("T", bound="LinuxAgentManagementBackupServerPolicyModel")


@_attrs_define
class LinuxAgentManagementBackupServerPolicyModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_agent_management_backup_server_policy_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        linux_agent_management_backup_server_policy_model.additional_properties = d
        return linux_agent_management_backup_server_policy_model
