...
T = TypeVar("T", bound="CloudDirectorBackupJobSpec")


@_attrs_define
class CloudDirectorBackupJobSpec:
    """Backup job settings for Cloud Director VMs.
    ...
    Attributes:
        ...
        virtual_machines (BackupJobVirtualMachinesSpec | Unset): Included and excluded objects.
    ...
    virtual_machines: BackupJobVirtualMachinesSpec | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virtual_machines: BackupJobVirtualMachinesSpec | Unset
        if isinstance(_virtual_machines, Unset):
            virtual_machines = UNSET
        else:
            virtual_machines = BackupJobVirtualMachinesSpec.from_dict(_virtual_machines)
        ...
        cloud_director_backup_job_spec = cls(
            name=name,
            type_=type_,
            description=description,
        ...
        cloud_director_backup_job_spec.additional_properties = d
        return cloud_director_backup_job_spec
