...
class UserFilters:
    ...
    mfa_enabled_filter: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        mfa_enabled_filter = self.mfa_enabled_filter
        ...
        if mfa_enabled_filter is not UNSET:
            field_dict["mfaEnabledFilter"] = mfa_enabled_filter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mfa_enabled_filter = d.pop("mfaEnabledFilter", UNSET)
        ...
        user_filters = cls(
            ...
            mfa_enabled_filter=mfa_enabled_filter,
        )
