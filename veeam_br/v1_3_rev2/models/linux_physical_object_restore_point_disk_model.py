...
T = TypeVar("T", bound="LinuxPhysicalObjectRestorePointDiskModel")


@_attrs_define
class LinuxPhysicalObjectRestorePointDiskModel:
    """Linux physical machine disk.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_physical_object_restore_point_disk_model = cls(
            platform=platform,
            uid=uid,
            type_=type_,
            name=name,
        ...
        linux_physical_object_restore_point_disk_model.additional_properties = d
        return linux_physical_object_restore_point_disk_model
