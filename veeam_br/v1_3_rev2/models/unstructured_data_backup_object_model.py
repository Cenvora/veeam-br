...
T = TypeVar("T", bound="UnstructuredDataBackupObjectModel")


@_attrs_define
class UnstructuredDataBackupObjectModel:
    """Unstructured data backup object.
    ...
    Attributes:
        ...
        host_id (UUID): ID of the file server.
        ...
        file_server_id (UUID | Unset): ID of the file server.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unstructured_data_backup_object_model = cls(
            id=id,
        ...
        unstructured_data_backup_object_model.additional_properties = d
        return unstructured_data_backup_object_model
