...
T = TypeVar("T", bound="AgentBackupOracleSettingsModel")


@_attrs_define
class AgentBackupOracleSettingsModel:
    """Application-aware processing settings for Oracle databases.
    ...
    Attributes:
        ...
        delete_hours_count (int | Unset): Time period in hours to keep archived logs. This parameter must be specified
            if the `EBackupOracleLogsSettings` value is *deleteExpiredHours*.
        delete_g_bs_count (int | Unset): Maximum size for archived logs in GB. This parameter must be specified if the
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_backup_oracle_settings_model = cls(
        ...
        agent_backup_oracle_settings_model.additional_properties = d
        return agent_backup_oracle_settings_model
