...
class FileBackupJobModel:
    ...
    Attributes:
        ...
        objects (list[UnstructuredBackupJobObjectModel] | Unset): Array of objects processed by the backup job.
    ...
    objects: list[UnstructuredBackupJobObjectModel] | Unset = UNSET
