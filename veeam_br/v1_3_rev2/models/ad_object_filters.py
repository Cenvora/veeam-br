...
class ADObjectFilters:
    ...
    Attributes:
        ...
        order_asc (bool | Unset): If `true`, sorts Active Directory objects in ascending order by the `orderColumn`
            parameter.
        ...
        parent_id_filter (UUID | Unset): Filters Active Directory objects by parent object ID. Returns only direct
    ...
    parent_id_filter: UUID | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        parent_id_filter: str | Unset = UNSET
        if not isinstance(self.parent_id_filter, Unset):
            parent_id_filter = str(self.parent_id_filter)
        ...
        if parent_id_filter is not UNSET:
            field_dict["parentIdFilter"] = parent_id_filter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _parent_id_filter = d.pop("parentIdFilter", UNSET)
        parent_id_filter: UUID | Unset
        if isinstance(_parent_id_filter, Unset):
            parent_id_filter = UNSET
        else:
            parent_id_filter = UUID(_parent_id_filter)
