...
T = TypeVar("T", bound="WindowsPhysicalObjectRestorePointDiskModel")


@_attrs_define
class WindowsPhysicalObjectRestorePointDiskModel:
    """Windows physical machine disk.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_physical_object_restore_point_disk_model = cls(
            platform=platform,
            uid=uid,
            type_=type_,
            name=name,
        ...
        windows_physical_object_restore_point_disk_model.additional_properties = d
        return windows_physical_object_restore_point_disk_model
