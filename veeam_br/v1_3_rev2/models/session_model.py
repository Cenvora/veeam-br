...
from ..models.e_session_algorithm import ESessionAlgorithm
...
if TYPE_CHECKING:
    ...
    from ..models.session_retry_info import SessionRetryInfo
...
class SessionModel:
    ...
    Attributes:
        ...
        algorithm (ESessionAlgorithm | Unset): Session algorithm type.
        progress (None | SessionProgressType0 | Unset): Details on the progress of the session.
        original_session_id (UUID | Unset): Identifier of the original (first) session in the run chain. For the
            original run, the value equals *id*. For any retry session, the value equals the *id* of the original run.
        retry_info (SessionRetryInfo | Unset): Retry metadata for a backup session. Present only when the session is a
            retry of a previous run.
    """
    ...
    algorithm: ESessionAlgorithm | Unset = UNSET
    progress: None | SessionProgressType0 | Unset = UNSET
    original_session_id: UUID | Unset = UNSET
    retry_info: SessionRetryInfo | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        original_session_id: str | Unset = UNSET
        if not isinstance(self.original_session_id, Unset):
        ...
        if related_session_id is not UNSET:
            field_dict["relatedSessionId"] = related_session_id
        if algorithm is not UNSET:
            field_dict["algorithm"] = algorithm
        if progress is not UNSET:
            field_dict["progress"] = progress
        if original_session_id is not UNSET:
            field_dict["originalSessionId"] = original_session_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_related_session_id, Unset):
            ...
            related_session_id = UUID(_related_session_id)

        _algorithm = d.pop("algorithm", UNSET)
        algorithm: ESessionAlgorithm | Unset
        if isinstance(_algorithm, Unset):
            algorithm = UNSET
        else:
            algorithm = ESessionAlgorithm(_algorithm)
        ...
        _original_session_id = d.pop("originalSessionId", UNSET)
        original_session_id: UUID | Unset
        if isinstance(_original_session_id, Unset):
            original_session_id = UNSET
        else:
            original_session_id = UUID(_original_session_id)

        _retry_info = d.pop("retryInfo", UNSET)
        retry_info: SessionRetryInfo | Unset
        if isinstance(_retry_info, Unset):
            retry_info = UNSET
        else:
            retry_info = SessionRetryInfo.from_dict(_retry_info)
