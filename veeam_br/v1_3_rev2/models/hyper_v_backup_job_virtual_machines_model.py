...
@_attrs_define
class HyperVBackupJobVirtualMachinesModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_excludes, Unset):
            ...
            excludes = HyperVBackupJobExclusionsModel.from_dict(_excludes)

        hyper_v_backup_job_virtual_machines_model = cls(
            includes=includes,
            excludes=excludes,
        )

        hyper_v_backup_job_virtual_machines_model.additional_properties = d
        return hyper_v_backup_job_virtual_machines_model
