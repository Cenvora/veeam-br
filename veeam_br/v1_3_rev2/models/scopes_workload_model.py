...
T = TypeVar("T", bound="ScopesWorkloadModel")


@_attrs_define
class ScopesWorkloadModel:
    """Workload scope.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scopes_workload_model = cls(
            type_=type_,
        )

        scopes_workload_model.additional_properties = d
        return scopes_workload_model
