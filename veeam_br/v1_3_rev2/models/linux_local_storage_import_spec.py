...
T = TypeVar("T", bound="LinuxLocalStorageImportSpec")


@_attrs_define
class LinuxLocalStorageImportSpec:
    """Import settings for Linux-based repositories.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_local_storage_import_spec = cls(
            name=name,
            description=description,
            unique_id=unique_id,
            host_name=host_name,
        ...
        linux_local_storage_import_spec.additional_properties = d
        return linux_local_storage_import_spec
