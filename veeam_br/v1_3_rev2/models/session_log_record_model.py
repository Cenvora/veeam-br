...
class SessionLogRecordModel:
    ...
    Attributes:
        ...
        additional_info (list[CommonMetaInfo] | Unset): Additional information of the log record as a collection of key-
            value pairs.
    """
    ...
    additional_info: list[CommonMetaInfo] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _additional_info is not UNSET:
            ...
            for additional_info_item_data in _additional_info:
                additional_info_item = CommonMetaInfo.from_dict(additional_info_item_data)
