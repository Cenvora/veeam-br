...
class ObjectStorageBackupJobPrimaryRepositoryModel:
    ...
    Attributes:
        backup_repository_id (UUID | Unset): Backup repository ID. To get the ID, run the [Get All
            Repositories](Repositories#operation/GetAllRepositories) request.
        source_backup_id (UUID | Unset): Source backup ID. To get the ID, run the [Get All
