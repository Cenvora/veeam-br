...
T = TypeVar("T", bound="WasabiCloudStorageSpec")


@_attrs_define
class WasabiCloudStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wasabi_cloud_storage_spec.additional_properties = d
        return wasabi_cloud_storage_spec
