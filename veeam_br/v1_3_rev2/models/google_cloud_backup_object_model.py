...
T = TypeVar("T", bound="GoogleCloudBackupObjectModel")


@_attrs_define
class GoogleCloudBackupObjectModel:
    """Google Cloud backup object.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_cloud_backup_object_model = cls(
            id=id,
        ...
        google_cloud_backup_object_model.additional_properties = d
        return google_cloud_backup_object_model
