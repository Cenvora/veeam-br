...
class ManagedServersFilters:
    ...
    Attributes:
        ...
        skip_dedup_appliances (bool | Unset): If `true`, excludes Linux-based deduplication storage appliance hosts
            (such as ExaGrid, Quantum, Infinidat, Fujitsu) from the list. Default: False.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        skip_dedup_appliances = self.skip_dedup_appliances
        ...
        if skip_dedup_appliances is not UNSET:
            field_dict["skipDedupAppliances"] = skip_dedup_appliances
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        skip_dedup_appliances = d.pop("skipDedupAppliances", UNSET)
