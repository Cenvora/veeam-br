...
T = TypeVar("T", bound="GeneralOptionsEmailSettingsModel")


@_attrs_define
class GeneralOptionsEmailSettingsModel:
    ...
    Attributes:
        ...
        notify_on_last_retry (bool): If `true`, email notifications are sent about the final job status only (not per
            every job retry).
        ai_powered_report_enabled (bool | Unset): If `true`, Veeam Backup & Replication sends an AI-powered daily
            summary of all backup activities.
    """
    ...
    ai_powered_report_enabled: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        ai_powered_report_enabled = self.ai_powered_report_enabled
        ...
        if ai_powered_report_enabled is not UNSET:
            field_dict["aiPoweredReportEnabled"] = ai_powered_report_enabled
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ai_powered_report_enabled = d.pop("aiPoweredReportEnabled", UNSET)

        general_options_email_settings_model = cls(
            from_=from_,
            to=to,
            subject=subject,
            ...
            ai_powered_report_enabled=ai_powered_report_enabled,
        )

        general_options_email_settings_model.additional_properties = d
        return general_options_email_settings_model
