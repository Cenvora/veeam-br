...
if TYPE_CHECKING:
    from ..models.amazon_snowball_edge_storage_account_model import AmazonSnowballEdgeStorageAccountModel
...
T = TypeVar("T", bound="AmazonSnowballEdgeStorageModel")


@_attrs_define
class AmazonSnowballEdgeStorageModel:
    ...
    Attributes:
        ...
        account (AmazonSnowballEdgeStorageAccountModel): AWS account used to access the AWS Snowball Edge storage.
    ...
    account: AmazonSnowballEdgeStorageAccountModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account = AmazonSnowballEdgeStorageAccountModel.from_dict(d.pop("account"))
        ...
        amazon_snowball_edge_storage_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        amazon_snowball_edge_storage_model.additional_properties = d
        return amazon_snowball_edge_storage_model
