...
T = TypeVar("T", bound="EntraIDAuditLogBackupJobModel")


@_attrs_define
class EntraIDAuditLogBackupJobModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_audit_log_backup_job_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        entra_id_audit_log_backup_job_model.additional_properties = d
        return entra_id_audit_log_backup_job_model
