...
T = TypeVar("T", bound="WindowsAgentManagementBackupJobModel")


@_attrs_define
class WindowsAgentManagementBackupJobModel:
    """Backup job for Microsoft Windows machines.
    ...
    Attributes:
        ...
        include_usb_drives (bool | Unset): If `true`, the backup job backs up periodically connected USB drives.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_agent_management_backup_job_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        windows_agent_management_backup_job_model.additional_properties = d
        return windows_agent_management_backup_job_model
