...
T = TypeVar("T", bound="IPv4SettingsModel")


@_attrs_define
class IPv4SettingsModel:
    """IPv4 settings.

    Attributes:
        ip_address (str | Unset): Helper appliance IP address.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        i_pv_4_settings_model.additional_properties = d
        return i_pv_4_settings_model
