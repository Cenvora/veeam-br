...
class BackupTaskSessionModel:
    ...
    Attributes:
        ...
        platform_type (EPlatformType | Unset): Platform type.<p>`Test` is the platform of SureBackup content scan job
            (`SureBackupContentScan`) — backup verification and content scanning with antivirus software or YARA rules.</p>
        platform_id (UUID | Unset): ID of the platform of the processed object.
    """
    ...
    platform_type: EPlatformType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        platform_type: EPlatformType | Unset
        if isinstance(_platform_type, Unset):
            platform_type = UNSET
        else:
            platform_type = EPlatformType(_platform_type)
