...
T = TypeVar("T", bound="RepositoryImmutabilityModel")


@_attrs_define
class RepositoryImmutabilityModel:
    """Backup repository immutability settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repository_immutability_model = cls(
            is_enabled=is_enabled,
            days_count=days_count,
        )

        repository_immutability_model.additional_properties = d
        return repository_immutability_model
