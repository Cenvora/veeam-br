...
class RestoreTargetDatastoresSpec:
    ...
    Attributes:
        default_datastore (InventoryObjectModel | Unset): Inventory object properties.
        configuration_file_datastore (InventoryObjectModel | Unset): Inventory object properties.
        disk_mappings (list[RestoreTargetDatastoreSpec] | Unset): Array of disks and their locations in the target
            datastore.
    """

    default_datastore: InventoryObjectModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_datastore: InventoryObjectModel | Unset
        if isinstance(_default_datastore, Unset):
            default_datastore = UNSET
        else:
            default_datastore = InventoryObjectModel.from_dict(_default_datastore)
