...
T = TypeVar("T", bound="RecoveryMediaTaskModel")


@_attrs_define
class RecoveryMediaTaskModel:
    """Recovery media task.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recovery_media_task_model.additional_properties = d
        return recovery_media_task_model
