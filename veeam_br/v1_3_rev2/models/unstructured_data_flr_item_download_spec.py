...
T = TypeVar("T", bound="UnstructuredDataFLRItemDownloadSpec")


@_attrs_define
class UnstructuredDataFLRItemDownloadSpec:
    """Settings for downloading guest OS items from unstructured data share.

    Attributes:
        source_path (list[str]): Array of paths to the items that you want to download.
        is_recursive (bool | Unset): If `true`, all files and folders in the source path are download recursively.
        ...
        to_date_time (datetime.datetime | Unset): Date when the restore point was created. Use this property when
            download files and folders from an earlier restore point (the `restoreMode` value is `Custom`).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unstructured_data_flr_item_download_spec = cls(
        ...
        unstructured_data_flr_item_download_spec.additional_properties = d
        return unstructured_data_flr_item_download_spec
