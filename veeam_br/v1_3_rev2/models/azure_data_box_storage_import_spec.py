...
if TYPE_CHECKING:
    from ..models.azure_data_box_storage_account_import_model import AzureDataBoxStorageAccountImportModel
...
T = TypeVar("T", bound="AzureDataBoxStorageImportSpec")


@_attrs_define
class AzureDataBoxStorageImportSpec:
    """Settings for Microsoft Azure Data Box repository.
    ...
    Attributes:
        ...
        account (AzureDataBoxStorageAccountImportModel): Account used to access the Microsoft Azure Data Box storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account = AzureDataBoxStorageAccountImportModel.from_dict(d.pop("account"))
        ...
        azure_data_box_storage_import_spec = cls(
            name=name,
            description=description,
            unique_id=unique_id,
            type_=type_,
        ...
        azure_data_box_storage_import_spec.additional_properties = d
        return azure_data_box_storage_import_spec
