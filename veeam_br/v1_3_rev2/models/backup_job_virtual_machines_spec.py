...
class BackupJobVirtualMachinesSpec:
    ...
    Attributes:
        ...
        excludes (BackupJobExclusionsSpec | Unset): Objects excluded from the job.
    """

    includes: list[InventoryObjectModel] | Unset = UNSET
    excludes: BackupJobExclusionsSpec | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        excludes: BackupJobExclusionsSpec | Unset
