...
if TYPE_CHECKING:
    from ..models.ibm_cloud_storage_account_model import IBMCloudStorageAccountModel
...
T = TypeVar("T", bound="IBMCloudStorageModel")


@_attrs_define
class IBMCloudStorageModel:
    """IBM Cloud storage.
    ...
    Attributes:
        ...
        account (IBMCloudStorageAccountModel): Account used to access the IBM Cloud storage.
    ...
    account: IBMCloudStorageAccountModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account = IBMCloudStorageAccountModel.from_dict(d.pop("account"))
        ...
        ibm_cloud_storage_model.additional_properties = d
        return ibm_cloud_storage_model
