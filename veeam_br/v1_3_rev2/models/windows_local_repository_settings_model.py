...
T = TypeVar("T", bound="WindowsLocalRepositorySettingsModel")


@_attrs_define
class WindowsLocalRepositorySettingsModel:
    """Repository settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_local_repository_settings_model = cls(
            path=path,
        ...
        windows_local_repository_settings_model.additional_properties = d
        return windows_local_repository_settings_model
