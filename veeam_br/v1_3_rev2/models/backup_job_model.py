...
T = TypeVar("T", bound="BackupJobModel")
...
class BackupJobModel:
    ...
    Attributes:
        ...
        storage (BackupJobStorageModel): VMware vSphere backup storage settings.
        ...
        virtual_machines (BackupJobVirtualMachinesModel | Unset): Included and excluded objects.
    """
    ...
    virtual_machines: BackupJobVirtualMachinesModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage = BackupJobStorageModel.from_dict(d.pop("storage"))
        ...
        virtual_machines: BackupJobVirtualMachinesModel | Unset
        if isinstance(_virtual_machines, Unset):
            virtual_machines = UNSET
        else:
            virtual_machines = BackupJobVirtualMachinesModel.from_dict(_virtual_machines)

        backup_job_model = cls(
            id=id,
            name=name,
            type_=type_,
            description=description,
        ...
        backup_job_model.additional_properties = d
        return backup_job_model
