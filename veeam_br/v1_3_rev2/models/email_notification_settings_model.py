...
class EmailNotificationSettingsModel:
    ...
    Attributes:
        ...
        send_daily_summary (bool | Unset): If `true`, a daily summary email is sent to the recipients.
        daily_summary_local_time (str | Unset): Local time when the daily summary is sent.
    ...
    send_daily_summary: bool | Unset = UNSET
    daily_summary_local_time: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        daily_summary_local_time = self.daily_summary_local_time
        ...
        if send_daily_summary is not UNSET:
            field_dict["sendDailySummary"] = send_daily_summary
        if daily_summary_local_time is not UNSET:
            field_dict["dailySummaryLocalTime"] = daily_summary_local_time
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        send_daily_summary = d.pop("sendDailySummary", UNSET)

        daily_summary_local_time = d.pop("dailySummaryLocalTime", UNSET)
        ...
        email_notification_settings_model = cls(
            ...
            daily_summary_local_time=daily_summary_local_time,
