...
if TYPE_CHECKING:
    from ..models.backup_source_object_model import BackupSourceObjectModel
...
class BackupCopyIncludeObjectsModel:
    ...
    Attributes:
        ...
        backups (list[BackupSourceObjectModel] | Unset): Array of backups processed by the job.
    """

    jobs: list[JobObjectModel] | Unset = UNSET
    repositories: list[RepositoryObjectModel] | Unset = UNSET
    backups: list[BackupSourceObjectModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _backups is not UNSET:
            ...
            for backups_item_data in _backups:
                backups_item = BackupSourceObjectModel.from_dict(backups_item_data)
