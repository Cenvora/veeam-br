...
if TYPE_CHECKING:
    ...
    from ..models.vi_vm_quick_migration_datastores_spec import ViVMQuickMigrationDatastoresSpec
...
class ViVMQuickMigrationSpec:
    ...
    Attributes:
        ...
        datastore (ViVMQuickMigrationDatastoresSpec | Unset): Destination datastore.
    ...
    datastore: ViVMQuickMigrationDatastoresSpec | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        datastore: ViVMQuickMigrationDatastoresSpec | Unset
        if isinstance(_datastore, Unset):
            datastore = UNSET
        else:
            datastore = ViVMQuickMigrationDatastoresSpec.from_dict(_datastore)
