...
class RepositoryStatesFilters:
    ...
    Attributes:
        ...
        name_filter (str | Unset): Filters repositories by the `nameFilter` pattern. The pattern can match any
            ...
            and/or at the end.
        type_filter (list[ERepositoryType] | Unset): Filters repositories by type. Multiple values may be specified to
            match any of them.
        ...
        is_online_filter (bool | Unset): If `true`, filters repositories by the repository connection status.
        is_out_of_date_filter (bool | Unset): If `true`, filters repositories by the repository components status.
        ...
        exclude_extents (bool | Unset): If `true`, filters out repositories that are a part of an extent for Scale-Out
            repositories.
        read_only_filter (bool | Unset): If `true`, filters repositories by the read-only mark.
    """
    ...
    read_only_filter: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        read_only_filter = self.read_only_filter
        ...
        if read_only_filter is not UNSET:
            field_dict["readOnlyFilter"] = read_only_filter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        read_only_filter = d.pop("readOnlyFilter", UNSET)
