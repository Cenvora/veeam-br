...
if TYPE_CHECKING:
    ...
    from ..models.symbolic_links_settings_model import SymbolicLinksSettingsModel
...
class FileBackupJobAdvancedSettingsModel:
    """Advanced settings for file share backup job.
    ...
    Attributes:
        ...
        symbolic_links (SymbolicLinksSettingsModel | Unset): Symbolic links settings.
        storage_data (FileBackupStorageSettingsModel | Unset): Storage settings for file share backup.
        ...
        notifications (FileBackupNotificationSettingsModel | Unset): Notification settings for file share backup job.
    """

    file_versions: BackupItemVersionsSettingsModel | Unset = UNSET
    acl_handling: ACLHandlingSettingsModel | Unset = UNSET
    symbolic_links: SymbolicLinksSettingsModel | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        symbolic_links: dict[str, Any] | Unset = UNSET
        if not isinstance(self.symbolic_links, Unset):
            symbolic_links = self.symbolic_links.to_dict()
        ...
        if symbolic_links is not UNSET:
            field_dict["symbolicLinks"] = symbolic_links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _symbolic_links = d.pop("symbolicLinks", UNSET)
        symbolic_links: SymbolicLinksSettingsModel | Unset
        if isinstance(_symbolic_links, Unset):
            symbolic_links = UNSET
        else:
            symbolic_links = SymbolicLinksSettingsModel.from_dict(_symbolic_links)
