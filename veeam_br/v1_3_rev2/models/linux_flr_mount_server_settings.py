...
class LinuxFlrMountServerSettings:
    """Mount server settings for file restore from Linux machines. Specify exactly one of `mountServerId`, `helperHost`,
    `helperAppliance`, or `originalHost` according to the value of `mountServerType`.
