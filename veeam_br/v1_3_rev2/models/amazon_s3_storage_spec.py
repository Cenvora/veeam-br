...
T = TypeVar("T", bound="AmazonS3StorageSpec")


@_attrs_define
class AmazonS3StorageSpec:
    """Amazon S3 storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        amazon_s3_storage_spec.additional_properties = d
        return amazon_s3_storage_spec
