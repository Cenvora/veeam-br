...
T = TypeVar("T", bound="QuantumDXiRepositorySettingsModel")


@_attrs_define
class QuantumDXiRepositorySettingsModel:
    """Quantum DXi repository settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quantum_d_xi_repository_settings_model = cls(
            path=path,
        ...
        quantum_d_xi_repository_settings_model.additional_properties = d
        return quantum_d_xi_repository_settings_model
