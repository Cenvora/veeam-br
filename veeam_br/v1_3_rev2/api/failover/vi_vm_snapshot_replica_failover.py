...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/failover/failoverNow/vSphere/snapshot",
    }
...
def sync_detailed(
    *,
    ...
    """Start Failover
     ...
     The HTTP POST request to the `/api/v1/failover/failoverNow/vSphere/snapshot` endpoint starts
    failover of VMware vSphere VMs to their snapshot replicas.<p>**Available to**&#58; Backup
