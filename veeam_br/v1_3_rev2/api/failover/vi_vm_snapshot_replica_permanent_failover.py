...
from ...models.vi_vm_snapshot_replica_failover_spec import ViVMSnapshotReplicaFailoverSpec
from ...types import Response


def _get_kwargs(
    *,
    body: ViVMSnapshotReplicaFailoverSpec,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/failover/permanentFailover/vSphere/snapshot",
    }
...
def sync_detailed(
    *,
    ...
    """Start Permanent Failover
     ...
     The HTTP POST request to the `/api/v1/failover/permanentFailover/vSphere/snapshot` endpoint starts
    permanent failover of VMware vSphere VMs to their snapshot replicas.<p>**Available to**&#58; Backup
    ...
    Args:
        ...
        body (ViVMSnapshotReplicaFailoverSpec): Failover settings of VMware vSphere snapshot
            replicas.
