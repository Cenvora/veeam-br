...
def sync_detailed(
    *,
    ...
    """Add Repository
     ...
     The HTTP POST request to the `/api/v1/backupInfrastructure/repositories` endpoint adds a repository
    to the backup infrastructure.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        overwrite_owner (bool | Unset):
        x_api_version (str):  Default: '1.3-rev2'.
        body (RepositorySpec): Backup repository settings.
