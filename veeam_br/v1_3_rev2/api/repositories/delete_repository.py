...
def sync_detailed(
    ...
    *,
    ...
    """Remove Repository
     ...
     The HTTP DELETE request to the `/api/v1/backupInfrastructure/repositories/{id}` endpoint removes a
    backup repository that has the specified `id` from the backup infrastructure.<p>**Available
