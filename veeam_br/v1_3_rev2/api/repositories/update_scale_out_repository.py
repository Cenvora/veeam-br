...
def sync_detailed(
    ...
    *,
    ...
    """Edit Scale-Out Backup Repository
     ...
     The HTTP PUT request to the `/api/v1/backupInfrastructure/scaleOutRepositories/{id}` endpoint edits
    a scale-out backup repository that has the specified `id`.<p> **Available to**&#58; Backup
    Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (ScaleOutRepositoryModel): Scale-out backup repository.
