...
def sync_detailed(
    ...
    *,
    ...
    """Get Scale-Out Backup Repository
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/scaleOutRepositories/{id}` endpoint gets a
    scale-out backup repository that has the specified `id`.<p> **Available to**&#58; Backup
