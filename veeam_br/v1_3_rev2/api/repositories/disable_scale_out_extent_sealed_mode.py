...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupInfrastructure/scaleOutRepositories/{id}/disableSealedMode".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupInfrastructure/scaleOutRepositories/{id}/disableSealedMode` endpoint disables the
    Sealed mode for specified extents of a scale-out backup repository that has the specified
