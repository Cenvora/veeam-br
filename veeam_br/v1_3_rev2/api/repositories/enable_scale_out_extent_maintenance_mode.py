...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupInfrastructure/scaleOutRepositories/{id}/enableMaintenanceMode".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupInfrastructure/scaleOutRepositories/{id}/enableMaintenanceMode` endpoint enables the
    Maintenance mode for specified extents of a scale-out backup repository that has the specified
