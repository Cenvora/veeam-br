...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupInfrastructure/scaleOutRepositories/{id}/disableMaintenanceMode".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupInfrastructure/scaleOutRepositories/{id}/disableMaintenanceMode` endpoint disables
    the Maintenance mode for specified extents of a scale-out backup repository that has the specified
    `id`.<p> **Available to**&#58; Backup Administrator.</p>
