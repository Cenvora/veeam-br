...
def sync_detailed(
    ...
    *,
    ...
    """Get Global VM Exclusion
     ...
     The HTTP GET request to the `/api/v1/globalExclusions/vm/{id}` endpoint gets a global VM exclusion
    that has the specified `id`.<p> **Available to**&#58; Backup Administrator.</p>
