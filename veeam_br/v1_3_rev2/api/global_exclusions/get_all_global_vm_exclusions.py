...
from ...models.global_vm_exclusions_result import GlobalVMExclusionsResult
...
def sync_detailed(
    *,
    ...
    """Get All Global VM Exclusions
     ...
     The HTTP GET request to the `/api/v1/globalExclusions/vm` endpoint gets an array of VMs that are
    excluded from processing. <p>**Available to**&#58; Backup Administrator.</p>
