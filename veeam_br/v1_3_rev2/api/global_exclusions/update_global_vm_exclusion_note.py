...
from ...models.global_vm_exclusion_note_spec import GlobalVMExclusionNoteSpec
...
def sync_detailed(
    ...
    *,
    ...
    global VM exclusion that has the specified `id`.<p> **Available to**&#58; Backup Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (GlobalVMExclusionNoteSpec): Exclusion note.
