...
def sync_detailed(
    *,
    ...
    """Edit Configuration Backup
     ...
     The HTTP PUT request to the `/api/v1/configBackup` endpoint edits the configuration backup settings
    of the backup server.<p>**Available to**&#58; Backup Administrator.</p>
