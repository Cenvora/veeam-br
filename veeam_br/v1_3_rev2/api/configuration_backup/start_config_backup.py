...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/configBackup/backup",
    }
...
def sync_detailed(
    *,
    ...
    """Start Configuration Backup
     ...
     The HTTP POST request to the `/api/v1/configBackup/backup` endpoint starts a configuration
    backup.<p>**Available to**&#58; Backup Administrator, Backup Operator. Also available to custom
    roles that have backup permissions.</p>
