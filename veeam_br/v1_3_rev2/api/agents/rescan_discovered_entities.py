...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/rescan".format(
...
def sync_detailed(
    ...
    *,
    ...
    endpoint starts rescan jobs, which can install or upgrade agents on a subset of discovered entities
    in the protection group that has the specified `id`. <p>**Available to**&#58; Backup
    Administrator.</p>
