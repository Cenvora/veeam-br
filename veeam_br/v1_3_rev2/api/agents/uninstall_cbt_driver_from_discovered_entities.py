...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallCBTDriver".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallCBTDriver` endpoint uninstalls the
    Changed Block Tracking (CBT) driver from discovered entities in the protection group that has the
    specified `id`. To complete the driver uninstallation process, reboot the computer. <p>**Available
