...
def sync_detailed(
    ...
    *,
    ...
    agent installation packages for the protection group. Use this request with protection groups with
    pre-installed backup agents. <p>**Available to**&#58; Backup Administrator.</p>
