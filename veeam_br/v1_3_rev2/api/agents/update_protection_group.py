...
def sync_detailed(
    ...
    *,
    ...
    """Edit Protection Group
     ...
     The HTTP PUT request to the `/api/v1/agents/protectionGroups/{id}` endpoint edits the settings of a
    protection group that has the specified `id`. <p>**Available to**&#58; Backup Administrator.</p>

    Args:
        id (UUID):
        perform_rescan (bool | Unset):  Default: False.
        x_api_version (str):  Default: '1.3-rev2'.
        body (ProtectionGroupModel): Protection group.
