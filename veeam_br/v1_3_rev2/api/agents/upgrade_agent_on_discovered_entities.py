...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/upgradeAgent".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upgrade Agent on Discovered Entities
     ...
     The HTTP POST request to the `/api/v1/agents/protectionGroups/{id}/discoveredEntities/upgradeAgent`
    endpoint upgrades the Veeam Agent on discovered entities in the protection group that has the
