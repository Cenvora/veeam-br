...
def sync_detailed(
    ...
    *,
    ...
    """Get Protection Group
     ...
     The HTTP GET request to the `/api/v1/agents/protectionGroups/{id}` endpoint gets a protection group
    that has the specified `id`. <p>**Available to**&#58; Backup Administrator, Restore Operator. Also
