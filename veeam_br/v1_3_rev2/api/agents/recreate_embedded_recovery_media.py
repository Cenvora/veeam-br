...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/recreateEmbeddedRm".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/recreateEmbeddedRm` endpoint schedules
    recreation of embedded recovery media on agent hosts in the protection group that has the specified
