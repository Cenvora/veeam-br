...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/reboot".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Reboot Discovered Entities
     ...
     The HTTP POST request to the `/api/v1/agents/protectionGroups/{id}/discoveredEntities/reboot`
    endpoint reboots a subset of discovered entities in the protection group that has the specified
