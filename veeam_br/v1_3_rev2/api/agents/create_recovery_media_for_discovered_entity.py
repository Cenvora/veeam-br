...
def sync_detailed(
    ...
    *,
    ...
    information, see [Create Recovery Media for Backup Object](Backup-
    Objects#operation/CreateRecoveryMediaForBackupObject). <p>**Deprecated**&#58; this synchronous
    endpoint blocks while the ISO is being created and returns a generic HTTP 500 on failure. Use the
    [Create Recovery Media Task for Discovered
    Entity](Agents#operation/CreateRecoveryMediaTaskForDiscoveredEntity) request followed by the
    [Download Recovery Media](Recovery-Media#operation/DownloadRecoveryMedia) request
    instead.</p><p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to
