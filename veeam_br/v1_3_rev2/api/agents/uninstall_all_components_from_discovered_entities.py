...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallAllComponents".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallAllComponents` endpoint uninstalls
    all components from discovered entities in the protection group that has the specified `id`.
    <p>**Available to**&#58; Backup Administrator.</p>
