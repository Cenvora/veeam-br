...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallAgent".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallAgent` endpoint uninstalls Veeam
    Agent from discovered entities in the protection group that has the specified `id`. <p>**Available
