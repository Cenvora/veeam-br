...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/installAgent".format(
...
def sync_detailed(
    ...
    *,
    ...
    endpoint installs Veeam Agent on discovered entities in the protection group that has the specified
