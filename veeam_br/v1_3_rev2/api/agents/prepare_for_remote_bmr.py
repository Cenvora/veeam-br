...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/protectionGroups/{id}/discoveredEntities/prepareForRemoteBmr".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/prepareForRemoteBmr` endpoint prepares
    agent hosts for Remote Bare Metal Recovery, in the protection group that has the specified `id`.
