...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agents/recoveryAppliances/{id}/reboot".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Reboots Agents Recovery Appliance
     ...
     The HTTP POST request to the `/api/v1/agents/recoveryAppliances/{id}/reboot` endpoint reboots an
    agents recovery appliance that has the specified `id`. <p>**Available to**&#58; Backup
