...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/flr/{session_id}/unmount".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Unmount File System
     ...
     The HTTP POST request to the `/api/v1/restore/flr/{sessionId}/unmount` endpoint unmounts the file
    system from a mount point and stops a file restore session that has the specified
