...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/instantRecovery/azure/vm/{mount_id}/switchover".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Start Switchover to Microsoft Azure

     The HTTP POST request to the `/api/v1/restore/instantRecovery/azure/vm/{mountId}/switchover`
    endpoint starts switchover for a mount point that has the specified `mountID`.<p>**Available
