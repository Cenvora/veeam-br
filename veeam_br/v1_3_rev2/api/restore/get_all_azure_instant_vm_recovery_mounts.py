...
from ...models.azure_instant_vm_recovery_mounts_result import AzureInstantVMRecoveryMountsResult
...
def sync_detailed(
    *,
    ...
    Instant Recovery mount points of Microsoft Azure VMs. <p>**Available to**&#58; Backup Administrator,
