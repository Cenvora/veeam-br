...
def sync_detailed(
    ...
    *,
    ...
    """Get FCD Mount Point
     ...
     The HTTP GET request to the `/api/v1/restore/instantRecovery/vSphere/fcd/{mountId}` endpoint gets
    information about the mounted vPower NFS datastore, such as restore session ID, mount point state,
    instant FCD recovery settings and disks that will be recovered.<p>**Available to**&#58; Backup
