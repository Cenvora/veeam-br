...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/instantRecovery/hyperV/vm/{mount_id}/unmount".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Publishing Machine to Microsoft Hyper-V

     The HTTP POST request to the `/api/v1/restore/instantRecovery/hyperV/vm/{mountId}/unmount` endpoint
    stops publishing the recovered machine and removes it from the destination host.<p>**Available
