...
def sync_detailed(
    ...
    *,
    ...
    """Start Migrating Machine to Microsoft Azure

     The HTTP POST request to the `/api/v1/restore/instantRecovery/azure/vm/{mountId}/migrate` endpoint
    starts VM migration from the specified Instant Recovery mount point.<p>**Available to**&#58; Backup
    Administrator.</p>
