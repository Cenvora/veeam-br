...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/instantRecovery/vSphere/vm/{mount_id}/unmount".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Publishing Machine to VMware vSphere

     The HTTP POST request to the `/api/v1/restore/instantRecovery/vSphere/vm/{mountId}/unmount` endpoint
