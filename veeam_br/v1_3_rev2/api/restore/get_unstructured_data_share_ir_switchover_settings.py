...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/restore/instantRecovery/unstructuredData/{mountId}/switchoverSettings` endpoint gets
    switchover settings for a mount point that has the specified `mountID`.<p>**Available to**&#58;
