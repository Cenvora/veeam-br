...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/unstructuredData/{session_id}/unmount".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Unmount Unstructured Data FLR Volumes
     ...
     The HTTP POST request to the `/api/v1/restore/unstructuredData/{sessionId}/unmount` endpoint
    unmounts unstructured data backup files from a mount point and stops a file restore session that has
    the specified `sessionId`.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also
