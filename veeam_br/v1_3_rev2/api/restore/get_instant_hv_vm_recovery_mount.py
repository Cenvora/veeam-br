...
def sync_detailed(
    ...
    *,
    ...
    """Get Mount Point for Instant Recovery to Microsoft Hyper-V

     The HTTP GET request to the `/api/v1/restore/instantRecovery/hyperV/vm/{mountId}` endpoint gets an
