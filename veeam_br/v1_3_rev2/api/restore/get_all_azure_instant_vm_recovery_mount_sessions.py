...
def sync_detailed(
    ...
    *,
    ...
    """Get All Mount Sessions for Instant Recovery to Microsoft Azure

     The HTTP GET request to the `/api/v1/restore/instantRecovery/azure/vm/{mountId}/sessions` endpoint
    gets an array of Instant Recovery sessions associated with a mount point.<p>**Available to**&#58;
