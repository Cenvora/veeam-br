...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/flr/unstructuredData",
    }
...
def sync_detailed(
    *,
    ...
    """Start File Restore from Unstructured Data Backup
     ...
     The HTTP POST request to the `/api/v1/restore/flr/unstructuredData` endpoint starts file restore
    from an unstructured data backup. The operation starts a file restore session and mounts the share
    to a mount point.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to
