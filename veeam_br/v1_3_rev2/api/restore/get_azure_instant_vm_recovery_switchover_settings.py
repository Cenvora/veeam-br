...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AzureInstantVMRecoverySwitchoverSettingsModel.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get Settings for Switchover to Microsoft Azure

     The HTTP GET request to the `/api/v1/restore/instantRecovery/azure/vm/{mountId}/switchoverSettings`
    endpoint gets switchover settings for an Instant Recovery mount point that has the specified
    `mountID`.<p>**Available to**&#58; Backup Administrator.</p>
