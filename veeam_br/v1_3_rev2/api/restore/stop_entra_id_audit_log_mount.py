...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/entraId/auditLog/{session_id}/unmount".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Unmount Microsoft Entra ID Audit Logs
     ...
     The HTTP POST request to the `/api/v1/restore/entraId/auditLog/{sessionId}/unmount` endpoint
    unmounts Microsoft Entra ID log files from a mount point and stops a file restore session that has
