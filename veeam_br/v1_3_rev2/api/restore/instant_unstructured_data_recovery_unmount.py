...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/instantRecovery/unstructuredData/{mount_id}/unmount".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Stop File Share Publishing
     ...
     The HTTP POST request to the `/api/v1/restore/instantRecovery/unstructuredData/{mountId}/unmount`
    endpoint stops publishing the file share and removes it from the destination server.<p>**Available
