...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/restore/instantRecovery/vSphere/fcd/{mount_id}/dismount".format(
...
def sync_detailed(
    ...
    *,
    ...
    endpoint stops publishing the recovered FCDs and removes the disks from the datastore.<p>**Available
