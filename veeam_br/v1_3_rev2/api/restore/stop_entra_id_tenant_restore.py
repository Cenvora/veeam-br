...
def sync_detailed(
    ...
    *,
    ...
    """Unmount Microsoft Entra ID Tenant
     ...
     The HTTP POST request to the `/api/v1/restore/entraId/tenant/{sessionId}/stop` endpoint unmounts a
    Microsoft Entra ID tenant and stops a mount session that has the specified
    ...
    Args:
        ...
        body (JobStopSpec | Unset): Job stop settings.
