...
def sync_detailed(
    ...
    *,
    ...
    """Get Unstructured Data Server
     ...
     The HTTP GET request to the `/api/v1/inventory/unstructuredDataServers/{id}` endpoint gets an
    unstructured data server that has the specified `id`.<p>**Available to**&#58; Backup Administrator,
