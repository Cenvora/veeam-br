...
def sync_detailed(
    *,
    ...
    """Get All Microsoft Entra ID Tenants
     ...
     The HTTP GET request to the `/api/v1/inventory/entraId/tenants` endpoint gets an array of all
    Microsoft Entra ID tenants added to the backup server.<p>**Available to**&#58; Backup Administrator,
    Backup Operator, Restore Operator, Backup Viewer. Also available to custom roles that have backup or
