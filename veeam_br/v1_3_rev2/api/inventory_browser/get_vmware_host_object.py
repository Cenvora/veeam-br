...
def sync_detailed(
    ...
    *,
    ...
    virtual infrastructure objects of the VMware vSphere server that has the specified
    `name`.<p>**Available to**&#58; Backup Administrator, Backup Operator, Restore Operator. Also
