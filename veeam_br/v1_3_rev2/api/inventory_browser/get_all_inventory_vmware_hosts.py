...
def sync_detailed(
    *,
    ...
    """Get All VMware vSphere Servers
     ...
     The HTTP GET request to the `/api/v1/inventory/vmware/hosts` endpoint gets an array of all VMware
    vSphere servers added to the backup infrastructure.<p>**Available to**&#58; Backup Administrator,
