...
def sync_detailed(
    ...
    *,
    ...
    """Remove Microsoft Entra ID Tenant
     ...
     The HTTP DELETE request to the `/api/v1/inventory/entraId/tenants/{id}` endpoint removes a Microsoft
    Entra ID tenant that has the specified `id` from the backup infrastructure.<p>**Available to**&#58;
