...
def sync_detailed(
    *,
    ...
    r"""Get All Protection Groups
     ...
     The HTTP POST request to the `/api/v1/inventory/physical` endpoint gets an array of protection
    groups added to the physical and cloud infrastructure. <div class=\"attention\">
    <strong>NOTE</strong> <br> This request is only used to get protected computers in order to add them
    to a backup job. For more information on how to get, add and manage protection groups, see the
    [Agents](#/Agents/) section.</div> <p>**Available to**&#58; Backup Administrator, Restore Operator.
