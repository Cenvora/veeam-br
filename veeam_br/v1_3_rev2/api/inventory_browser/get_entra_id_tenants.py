...
def sync_detailed(
    ...
    *,
    ...
    """Get Microsoft Entra ID Tenant
     ...
     The HTTP GET request to the `/api/v1/inventory/entraId/tenants/{id}` endpoint gets a Microsoft Entra
    ID tenant that has the specified `id`.<p>**Available to**&#58; Backup Administrator, Backup
