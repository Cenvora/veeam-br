...
def sync_detailed(
    ...
    *,
    ...
    """Get Inventory Objects for Specific Protection Group
     ...
     The HTTP POST request to the `/api/v1/inventory/physical/{protectionGroupId}` endpoint gets an array
    of inventory objects of physical or cloud machines for a protection group with the specified
    `protectionGroupId`. <p>**Available to**&#58; Backup Administrator, Restore Operator. Also available
    to custom roles that have backup or restore permissions.</p>
