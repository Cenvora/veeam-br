...
def _get_kwargs(
    ...
    *,
    ...
    json_parent_id_filter: str | Unset = UNSET
    if not isinstance(parent_id_filter, Unset):
        json_parent_id_filter = str(parent_id_filter)
    params["parentIdFilter"] = json_parent_id_filter
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order_column (EADObjectFiltersOrderColumn | Unset): Sorts Active Directory objects by one
            of the parameters.
