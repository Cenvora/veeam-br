...
def sync_detailed(
    *,
    ...
    """Get Node Exporter Settings
     ...
     The HTTP GET request to the `/api/v1/generalOptions/nodeExporterSettings` path allows you to get the
    node exporter settings. <p>**Available to**: Backup Administrator.</p>
