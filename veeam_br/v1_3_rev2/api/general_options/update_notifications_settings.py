...
def _get_kwargs(
    *,
    body: GeneralOptionsNotificationsModel,
...
def sync_detailed(
    *,
    ...
    """Edit Notification Settings
     ...
     The HTTP PUT request to the `/api/v1/generalOptions/notifications` endpoint edits Veeam Backup &
    Replication notification settings.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (GeneralOptionsNotificationsModel): Other notifications such as notifications on low
