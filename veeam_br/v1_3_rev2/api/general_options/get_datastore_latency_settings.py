...
def sync_detailed(
    ...
    *,
    ...
    """Get Latency Settings for Specific Datastore
     ...
     The HTTP GET request to the `/api/v1/generalOptions/storageLatency/datastores/{id}` endpoint gets
    custom latency settings configured for a specific datastore.<p>**Available to**&#58; Backup
    Administrator.</p>
