...
from ...models.general_options_event_forwarding_model import GeneralOptionsEventForwardingModel
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/generalOptions/eventForwarding",
    }
...
def sync_detailed(
    *,
    ...
    Replication event forwarding settings.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (GeneralOptionsEventForwardingModel): Event forwarding settings.
