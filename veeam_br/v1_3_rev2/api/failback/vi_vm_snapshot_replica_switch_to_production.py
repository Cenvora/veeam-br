...
from ...models.vi_vm_snapshot_replica_switch_to_production_failback_spec import (
...
def _get_kwargs(
    *,
    body: ViVMSnapshotReplicaSwitchToProductionFailbackSpec,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/failback/switchToProduction/vSphere/snapshot",
    }
...
def sync_detailed(
    *,
    ...
    """Switch over to Production
     ...
     The HTTP POST request to the `/api/v1/failback/switchToProduction/vSphere/snapshot` endpoint
    manually starts switchover from snapshot replicas to production VMware vSphere VMs.<p>**Available
    ...
    Args:
        ...
        body (ViVMSnapshotReplicaSwitchToProductionFailbackSpec): Settings for switching over from
            a snapshot replica to production.
