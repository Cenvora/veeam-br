...
from ...models.vi_vm_snapshot_replica_commit_failback_spec import ViVMSnapshotReplicaCommitFailbackSpec
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/failback/commitFailback/vSphere/snapshot",
    }
...
def sync_detailed(
    *,
    ...
    """Commit Failback
     ...
     The HTTP POST request to the `/api/v1/failback/commitFailback/vSphere/snapshot` endpoint commits
    ...
    Args:
        ...
        body (ViVMSnapshotReplicaCommitFailbackSpec): Settings for performing failback of snapshot
