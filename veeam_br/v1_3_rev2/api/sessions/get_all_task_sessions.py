...
def sync_detailed(
    *,
    ...
    """Get All Task Sessions
     ...
     The HTTP GET request to the `/api/v1/taskSessions` endpoint gets an array of task sessions performed
    on the backup server.<p>**Available to**&#58; Backup Administrator, Backup Operator, Restore
