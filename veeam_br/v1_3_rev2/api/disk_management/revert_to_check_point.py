...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/revertToCheckPoint".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Revert to Disk Management Checkpoint
     ...
     The HTTP PUT request to the `/api/v1/diskManagement/{diskManagementSessionId}/revertToCheckPoint`
    endpoint reverts the restore layout state to the previously created checkpoint and discards all
    modifications made since that point.<p>**Available to**&#58; Backup Administrator, Restore Operator.
