...
from ...models.remove_disk_partition_operation_spec import RemoveDiskPartitionOperationSpec
...
def _get_kwargs(
    ...
    *,
    body: RemoveDiskPartitionOperationSpec,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/removePartition".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Remove Partition
     ...
     The HTTP POST request to the `/api/v1/diskManagement/{diskManagementSessionId}/removePartition`
    endpoint removes a partition from the specified disk.<p>**Available to**&#58; Backup Administrator,
    Restore Operator. Also available to custom roles that have restore permissions.</p>

    Args:
        disk_management_session_id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (RemoveDiskPartitionOperationSpec): Settings for removing a disk partition.
