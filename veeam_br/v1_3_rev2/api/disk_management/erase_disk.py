...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/eraseDisk".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Erase Disk
     ...
     The HTTP POST request to the `/api/v1/diskManagement/{diskManagementSessionId}/eraseDisk` endpoint
    erases all partitions and data from the specified disk.<p>**Available to**&#58; Backup
