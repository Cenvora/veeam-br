...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/createCheckPoint".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create Disk Management Checkpoint
     ...
     The HTTP PUT request to the `/api/v1/diskManagement/{diskManagementSessionId}/createCheckPoint`
    endpoint creates a checkpoint of the current restore layout state so that subsequent modifications
    can be reverted and discarded.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also
