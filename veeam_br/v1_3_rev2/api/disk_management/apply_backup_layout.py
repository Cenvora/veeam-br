...
from ...models.disk_operation_spec import DiskOperationSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/applyBackupLayout".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Apply Backup Layout
     ...
     The HTTP POST request to the `/api/v1/diskManagement/{diskManagementSessionId}/applyBackupLayout`
    endpoint applies the backup disk layout to the specified disk.<p>**Available to**&#58; Backup
    ...
    Args:
        ...
        body (DiskOperationSpec): Settings for a disk operation.
