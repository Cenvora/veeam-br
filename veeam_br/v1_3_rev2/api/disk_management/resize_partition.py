...
from ...models.resize_disk_partition_operation_spec import ResizeDiskPartitionOperationSpec
...
def _get_kwargs(
    ...
    *,
    body: ResizeDiskPartitionOperationSpec,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/resizePartition".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Resize Partition
     ...
     The HTTP POST request to the `/api/v1/diskManagement/{diskManagementSessionId}/resizePartition`
    endpoint resizes a partition on the specified disk.<p>**Available to**&#58; Backup Administrator,
    Restore Operator. Also available to custom roles that have restore permissions.</p>

    Args:
        disk_management_session_id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (ResizeDiskPartitionOperationSpec): Settings for resizing a disk partition.
