...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/diskManagement/{disk_management_session_id}/keepAlive".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Keep Disk Management Session Alive
     ...
     The HTTP PUT request to the `/api/v1/diskManagement/{diskManagementSessionId}/keepAlive` endpoint
    keeps the disk management session active.<p>**Available to**&#58; Backup Administrator, Restore
