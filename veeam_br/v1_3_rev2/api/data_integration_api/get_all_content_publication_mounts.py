...
def sync_detailed(
    *,
    ...
    """Get All Disk Publishing Mount Points
     ...
     The HTTP GET request to the `/api/v1/dataIntegration` endpoint gets an array of mount points for
    disk publishing operations.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also
