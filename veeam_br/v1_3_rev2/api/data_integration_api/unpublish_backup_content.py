...
def sync_detailed(
    ...
    *,
    ...
    """Stop Disk Publishing
     ...
     The HTTP POST request to the `/api/v1/dataIntegration/{mountId}/unpublish` endpoint stops publishing
    a mount point that has the specified `mountID`. <p>**Available to**&#58; Backup Administrator,
