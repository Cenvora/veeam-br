...
def sync_detailed(
    ...
    *,
    ...
    """Get Disk Publishing Mount Point
     ...
     The HTTP GET request to the `/api/v1/dataIntegration/{mountId}` endpoint gets a disk publishing
    mount point that has the specified `mountID`.<p>**Available to**&#58; Backup Administrator, Restore
