...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/acl/{object_type}/{object_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ACL Record
     ...
     The HTTP GET request to the `/api/v1/acl/{objectType}/{objectId}` endpoint gets an Access Control
    List (ACL) record for the object that has the specified `objectType` and `objectId`.<p>**Available
