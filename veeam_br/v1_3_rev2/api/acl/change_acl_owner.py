...
from ...models.acl_change_owner_spec import AclChangeOwnerSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/acl/{object_type}/{object_id}/changeOwner".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Change Owner of ACL Record
     ...
     The HTTP POST request to the `/api/v1/acl/{objectType}/{objectId}/changeOwner` endpoint changes the
    owner of an Access Control List (ACL) record for the object that has the specified `objectType` and
    `objectId`.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        object_type (EAclObjectKind): ACL object type.
        object_id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (AclChangeOwnerSpec): Settings for changing the ACL owner.
