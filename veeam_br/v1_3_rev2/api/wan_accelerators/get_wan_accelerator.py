...
def sync_detailed(
    ...
    *,
    ...
    """Get WAN Accelerator
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/wanAccelerators/{id}` endpoint gets a WAN
    accelerator that has the specified `id`.<p>**Available to**&#58; Backup Administrator, Restore
