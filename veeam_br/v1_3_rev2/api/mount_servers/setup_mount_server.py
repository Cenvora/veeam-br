...
from ...models.mount_server_spec import MountServerSpec
...
def sync_detailed(
    *,
    ...
    """Add Mount Server
     ...
     The HTTP POST request to the `/api/v1/backupInfrastructure/mountServers` endpoint assigns a mount
    server role to an existing managed server.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (MountServerSpec): Mount server.
