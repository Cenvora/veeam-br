...
def sync_detailed(
    ...
    *,
    ...
    """Update Mount Server
     ...
     The HTTP PUT request to the `/api/v1/backupInfrastructure/mountServers/{id}` endpoint updates the
    settings of a mount server that has the specified `id`.<p>**Available to**&#58; Backup
    Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (MountServerModel): Mount server.
