...
def sync_detailed(
    *,
    ...
    """Get Mount Servers
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/mountServers` endpoint gets managed
    servers that have been assigned the mount server role. <p>**Available to**&#58; Backup
