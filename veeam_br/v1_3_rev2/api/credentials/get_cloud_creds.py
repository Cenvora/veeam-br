...
def sync_detailed(
    ...
    *,
    ...
    """Get Cloud Credentials Record
     ...
     The HTTP GET request to the `/api/v1/cloudCredentials/{id}` endpoint gets a cloud credentials record
    that has the specified `id`.<p>**Available to**&#58; Backup Administrator, Security
    Administrator.</p>
