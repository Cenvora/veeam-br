...
def sync_detailed(
    ...
    *,
    ...
    """Change Secret Key
     ...
     The HTTP POST request to the `/api/v1/cloudCredentials/{id}/changeSecretKey` endpoint changes a
    secret key of a cloud credentials record that has the specified `id`.<p>**Available to**&#58; Backup
    Administrator, Security Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (CloudCredentialsPasswordSpec): Settings for cloud credentials password.
