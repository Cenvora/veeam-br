...
) -> Error | GoogleCloudComputeVerificationCodeModel | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | GoogleCloudComputeVerificationCodeModel]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Google Authentication Information
     ...
     The HTTP POST request to the `/api/v1/cloudCredentials/authenticate` endpoint gets authentication
    information required to sign in to Google Cloud.<p> **Available to**&#58; Backup Administrator,
...
def sync(
    *,
    ...
    Returns:
        Error | GoogleCloudComputeVerificationCodeModel
    """
