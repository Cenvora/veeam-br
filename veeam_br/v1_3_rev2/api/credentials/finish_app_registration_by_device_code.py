...
def sync_detailed(
    ...
    *,
    ...
    """Register Microsoft Entra ID Application
     ...
     The HTTP POST request to the `/api/v1/cloudCredentials/appRegistration/{verificationCode}` endpoint
    registers a new Microsoft Entra ID application using the specified `verificationCode`.<p>**Available
    to**&#58; Backup Administrator, Security Administrator.</p>
