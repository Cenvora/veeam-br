...
def sync_detailed(
    ...
    *,
    ...
    """Edit Credentials Record
     ...
     The HTTP PUT request to the `/api/v1/credentials/{id}` endpoint edits a credentials record that has
    the specified `id`.<p> **Available to**&#58; Backup Administrator, Security Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (CredentialsModel): Credentials record.
