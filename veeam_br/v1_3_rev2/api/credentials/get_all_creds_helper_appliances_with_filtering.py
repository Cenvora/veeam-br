...
def sync_detailed(
    ...
    *,
    ...
    """Get All Helper Appliances
     ...
     The HTTP GET request to the `/api/v1/cloudCredentials/{id}/helperAppliances` endpoint gets an array
    of Linux-based helper appliances of a Microsoft Azure compute account that has the specified
    `id`.<p>**Available to**&#58; Backup Administrator, Security Administrator.</p>
