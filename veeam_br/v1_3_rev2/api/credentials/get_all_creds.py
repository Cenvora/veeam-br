...
def sync_detailed(
    *,
    ...
    """Get All Credentials
     ...
     The HTTP GET request to the `/api/v1/credentials` endpoint gets an array of credentials records that
    are added to the backup server.<p>**Available to**&#58; Backup Administrator, Backup Operator,
    Restore Operator, Security Administrator. Also available to custom roles that have backup or restore
    permissions.</p>
