...
def sync_detailed(
    ...
    *,
    ...
    the specified `id`.<p>**Available to**&#58; Backup Administrator, Backup Operator, Restore Operator,
    Security Administrator. Also available to custom roles that have backup or restore permissions.</p>
