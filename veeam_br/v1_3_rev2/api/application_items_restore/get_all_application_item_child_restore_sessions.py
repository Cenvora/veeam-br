...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/restore/applicationItems/{browse_session_id}/childSessions".format(
            browse_session_id=quote(str(browse_session_id), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get All Child Restore Sessions for Application Item Browse Session
     ...
     The HTTP GET request to the `/api/v1/restore/applicationItems/{browseSessionId}/childSessions`
    endpoint gets an array of restore sessions associated with the application item browse session that
    has the specified `browseSessionId`.<p>**Available to**&#58; Backup Administrator, Restore Operator.
