...
def sync_detailed(
    *,
    ...
    """Delete High Availability Cluster
     ...
     The HTTP DELETE request to the `/api/v1/highAvailabilityCluster` endpoint removes the High
    Availability cluster configuration. This is an asynchronous operation that returns a session for
    tracking progress.<p>**Available to**&#58; Backup Administrator.</p>
