...
def sync_detailed(
    *,
    ...
    """Get Backup Server Information
     ...
     The HTTP GET request to the `/api/v1/serverInfo` endpoint returns the Veeam Backup & Replication
    installation ID, backup server name (or IP address), build number, and cumulative patches installed
    on the backup server.<p>**Available to**&#58; Backup Administrator.</p>
