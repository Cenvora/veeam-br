...
from ...models.user_role_settings_model import UserRoleSettingsModel
...
def sync_detailed(
    *,
    ...
    """Get MFA Settings
     ...
     The HTTP GET request to the `/api/v1/security/settings` endpoint checks whether multi-factor
    authentication (MFA) is enabled or disabled for all users.<p>**Available to**&#58; Backup
    Administrator.</p>
