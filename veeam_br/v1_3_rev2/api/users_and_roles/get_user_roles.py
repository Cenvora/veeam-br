...
def sync_detailed(
    ...
    *,
    ...
    """Get Roles Assigned to User or Group
     ...
     The HTTP GET request to the `/api/v1/security/users/{id}/roles` endpoint gets the roles assigned to
    a user or group that has the specified `id`.<p>**Available to**&#58; Backup Administrator.</p>
