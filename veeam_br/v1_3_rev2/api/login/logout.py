...
def sync_detailed(
    *,
    ...
    """Log Out
     ...
     The HTTP POST request to the `/api/oauth2/logout` endpoint performs a logout operation. After you
    log out, your access and refresh tokens become invalid.<p>**Available to**&#58; All user roles.</p>
