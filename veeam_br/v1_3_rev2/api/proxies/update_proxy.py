...
def sync_detailed(
    ...
    *,
    ...
    """Edit Proxy
     ...
     The HTTP PUT request to the `/api/v1/backupInfrastructure/proxies/{id}` endpoint edits a backup
    proxy that has the specified `id`.<p>**Available to**&#58; Backup Administrator.</p>
