...
def sync_detailed(
    *,
    ...
    """Get All Proxies
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/proxies` endpoint gets an array of all
    backup proxies that are added to the backup infrastructure.<p>**Available to**&#58; Backup
