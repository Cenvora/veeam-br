...
from ...models.proxies_states_result import ProxiesStatesResult
...
def _get_kwargs(
    *,
    ...
    params["isDisabledFilter"] = is_disabled_filter
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/backupInfrastructure/proxies/states",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    proxy states.<p>**Available to**&#58; Backup Administrator, Backup Operator, Restore Operator,
