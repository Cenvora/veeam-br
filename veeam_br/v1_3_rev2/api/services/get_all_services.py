...
from ...models.e_services_filters_order_column import EServicesFiltersOrderColumn
from ...models.error import Error
from ...models.services_result import ServicesResult
...
def sync_detailed(
    *,
    ...
    """Get Associated Services
     ...
     The HTTP GET request to the `/api/v1/services` endpoint gets associated services for integration
    with Veeam Backup & Replication.<p>**Available to**&#58; Backup Administrator.</p>
