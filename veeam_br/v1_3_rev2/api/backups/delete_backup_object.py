...
def sync_detailed(
    ...
    *,
    ...
    """Delete Backup Object
     ...
     The HTTP DELETE request to the `/api/v1/backups/{id}/objects/{objectId}` endpoint deletes an
    infrastructure object (VM or VM container) included in a backup that has the specified `id`.
    <p>Types of backup objects differ depending on the backup job platform:<ul> <li>Backups of VMware
    vSphere, Microsoft Hyper-V, Nutanix AHV, and Proxmox VE jobs contain VMs only.</li> <li>Backups of
    VMware Cloud Director jobs contain VMs and vApps.</li></ul></p> <p>**Available to**&#58; Backup
    Administrator.</p>
