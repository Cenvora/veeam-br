...
def _get_kwargs(
    *,
    ...
    params["policyUniqueIdFilter"] = policy_unique_id_filter
...
def sync_detailed(
    *,
    ...
    on or imported to the backup server.<p>**Available to**&#58; Backup Administrator, Backup Operator,
    Restore Operator, Backup Viewer, Security Administrator. Also available to custom roles that have
    backup or restore permissions.</p>
