...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backups/{id}/backupFiles/{backup_file_id}/markAsInfected".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Mark Backup File as Infected
     ...
     The HTTP POST request to the `/api/v1/backups/{id}/backupFiles/{backupFileId}/markAsInfected`
    endpoint marks a backup file as infected.<p>**Available to**&#58; Backup Administrator, Incident API
    Operator.</p>
