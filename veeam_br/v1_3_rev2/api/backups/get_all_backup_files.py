...
def sync_detailed(
    ...
    *,
    ...
    """Get All Backup Files
     ...
     The HTTP GET request to the `/api/v1/backups/{id}/backupFiles` endpoint gets an array of all backup
    files in a backup that has the specified `id`.<p>**Available to**&#58; Backup Administrator, Backup
