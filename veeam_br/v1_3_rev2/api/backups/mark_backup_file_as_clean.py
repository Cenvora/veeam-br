...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backups/{id}/backupFiles/{backup_file_id}/markAsClean".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Mark Backup File as Clean
     ...
     The HTTP POST request to the `/api/v1/backups/{id}/backupFiles/{backupFileId}/markAsClean` endpoint
    marks a backup file as clean.<p>**Available to**&#58; Backup Administrator, Incident API
    Operator.</p>
