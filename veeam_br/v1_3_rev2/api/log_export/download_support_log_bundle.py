...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/exportlogs/{session_id}/download".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Download Logs
     ...
     The HTTP GET request to the `/api/v1/exportlogs/{sessionId}/download` endpoint downloads the logs
    generated by the specified export session as a ZIP file. <p>**Available to**&#58; Backup
    Administrator.</p>
