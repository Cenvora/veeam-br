...
def sync_detailed(
    *,
    ...
    """Modify Security & Compliance Analyzer Schedule
     ...
     The HTTP PUT request to the `/api/v1/securityAnalyzer/schedule` endpoint modifies the Security &
    Compliance Analyzer schedule.<p>**Available to**&#58; Backup Administrator, Security
    Administrator.</p>
