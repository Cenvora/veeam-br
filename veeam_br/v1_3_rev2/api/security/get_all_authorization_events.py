    ...
    *,
    ...
    if not isinstance(state_filter, Unset):
        ...
        for state_filter_item_data in state_filter:
            ...
            json_state_filter.append(state_filter_item)
...
def sync_detailed(
    *,
    ...
    """Get All Authorization Events
     ...
     The HTTP GET request to the `/api/v1/authorization/events` endpoint gets an array of security-
    related events. These events cover the following operation types&#58;<ul> <li>Approved and rejected
    requests</li> <li>Updated four-eyes authorization settings</li> <li>Updated settings for users and
    user groups</li> <li>Assigned roles</li> <li>Added or deleted users and user groups</li></ul>
    <p>**Available to**&#58; Backup Administrator, Security Administrator.</p>
