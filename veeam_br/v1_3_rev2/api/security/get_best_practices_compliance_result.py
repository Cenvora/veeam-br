...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/securityAnalyzer/bestPractices",
    }
...
def sync_detailed(
    *,
    ...
    """Get Security & Compliance Analyzer Results
     ...
     The HTTP GET request to the `/api/v1/securityAnalyzer/bestPractices` endpoint gets best practices
    compliance result from the backup server.<p>**Available to**&#58; Backup Administrator, Security
    Administrator.</p>
