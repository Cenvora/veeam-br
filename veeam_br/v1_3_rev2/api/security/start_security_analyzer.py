...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/securityAnalyzer/start",
    }
...
def sync_detailed(
    *,
    ...
    """Start Security & Compliance Analyzer
     ...
     The HTTP POST request to the `/api/v1/securityAnalyzer/start` endpoint starts Security & Compliance
    Analyzer on the backup server.<p>**Available to**&#58; Backup Administrator, Security
    Administrator.</p>
