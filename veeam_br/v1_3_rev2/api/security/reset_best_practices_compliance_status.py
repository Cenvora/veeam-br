...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/securityAnalyzer/bestPractices/{id}/reset".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Reset Security & Compliance Analyzer Status
     ...
     The HTTP POST request to the `/api/v1/securityAnalyzer/bestPractices/{id}/reset` endpoint resets the
    compliance status of a Security & Compliance Analyzer best practice that has the specified `id`.
