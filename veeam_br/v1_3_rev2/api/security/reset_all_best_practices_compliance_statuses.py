...
def sync_detailed(
    *,
    ...
    """Reset All Security & Compliance Analyzer Statuses
     ...
     The HTTP POST request to the `/api/v1/securityAnalyzer/bestPractices/resetAll` endpoint restores
    default compliance statuses for all Security & Compliance Analyzer best practices.<p>**Available
