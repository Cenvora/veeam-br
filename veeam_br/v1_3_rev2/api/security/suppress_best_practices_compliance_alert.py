...
def sync_detailed(
    ...
    *,
    ...
    """Suppress Security & Compliance Analyzer Best Practice Status
     ...
     The HTTP POST request to the `/api/v1/securityAnalyzer/bestPractices/{id}/suppress` endpoint
    suppresses a Security & Compliance Analyzer best practice compliance status that has the specified
    best practice `id`. <p>**Available to**&#58; Backup Administrator, Security Administrator.</p>
