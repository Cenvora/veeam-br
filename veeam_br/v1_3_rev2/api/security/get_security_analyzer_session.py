...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/securityAnalyzer/lastRun",
    }
...
def sync_detailed(
    *,
    ...
    """Get Security & Compliance Analyzer Last Run
     ...
     The HTTP GET request to the `/api/v1/securityAnalyzer/lastRun` endpoint gets the last session of
    Security & Compliance Analyzer.<p>**Available to**&#58; Backup Administrator, Security
    Administrator.</p>
