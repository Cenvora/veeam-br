...
def _get_kwargs(
    *,
    ...
    skip_dedup_appliances: bool | Unset = False,
    ...
    params["skipDedupAppliances"] = skip_dedup_appliances
...
def sync_detailed(
    *,
    ...
    """Get All Servers
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/managedServers` endpoint gets an array of
    all servers that are added to the backup infrastructure.<p> **Available to**&#58; Backup
    ...
    Args:
        ...
        skip_dedup_appliances (bool | Unset):  Default: False.
    ...
    kwargs = _get_kwargs(
        ...
        skip_dedup_appliances=skip_dedup_appliances,
