...
def sync_detailed(
    ...
    *,
    ...
    """Remove Server
     ...
     The HTTP DELETE request to the `/api/v1/backupInfrastructure/managedServers/{id}` endpoint removes a
    managed server that has the specified `id` from the backup infrastructure.<p>**Available to**&#58;
