...
def sync_detailed(
    ...
    *,
    ...
    """Get Volumes for Microsoft Hyper-V Standalone Server

     The HTTP GET request to the `/api/v1/backupInfrastructure/managedServers/{id}/volumes` endpoint gets
    volumes on a managed server that has the specified `id`. Applicable only for Microsoft Hyper-V
    standalone server<p>**Available to**&#58; Backup Administrator.</p>
