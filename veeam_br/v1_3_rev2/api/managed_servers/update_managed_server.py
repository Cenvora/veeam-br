...
def sync_detailed(
    ...
    *,
    ...
    """Edit Server
     ...
     The HTTP PUT request to the `/api/v1/backupInfrastructure/managedServers/{id}` endpoint edits a
    managed server that has the specified `id`.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev2'.
        body (ManagedServerModel): Managed server.
