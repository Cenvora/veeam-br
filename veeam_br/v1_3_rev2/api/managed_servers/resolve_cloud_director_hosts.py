...
def sync_detailed(
    *,
    ...
    endpoint gets an array of vCenter Servers attached to a specific VMware Cloud Director server.<p>
    **Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (CloudDirectorHostDiscoverySpec): Settings for discovery of VMware Cloud Director
            server.
