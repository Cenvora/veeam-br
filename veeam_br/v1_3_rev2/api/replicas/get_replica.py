...
def sync_detailed(
    ...
    *,
    ...
    """Get Replica
     ...
     The HTTP GET request to the `/api/v1/replicas/{id}` endpoint gets a replica that has the specified
    `id`.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to custom roles
