...
def sync_detailed(
    *,
    ...
    """Get All Replicas
     ...
     The HTTP GET request to the `/api/v1/replicas` endpoint gets an array of all replicas that are
    created on the backup server.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also
