...
def sync_detailed(
    *,
    ...
    """Export Servers
     ...
     The HTTP POST request to the `/api/v1/automation/managedServers/export` endpoint exports managed
    servers from Veeam Backup & Replication.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (ManageServerExportSpec | Unset): Settings for exporting managed servers.
