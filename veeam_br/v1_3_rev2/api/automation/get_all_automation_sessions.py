...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/automation/sessions",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get All Automation Sessions
     ...
     The HTTP GET request to the `/api/v1/automation/sessions` endpoint gets an array of all automation
    sessions performed on the backup server.<p>**Available to**&#58; Backup Administrator, Backup
