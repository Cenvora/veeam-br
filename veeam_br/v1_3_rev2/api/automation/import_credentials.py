...
def _get_kwargs(
    *,
    body: CredentialsImportSpecCollection,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/automation/credentials/import",
    }
...
def sync_detailed(
    *,
    ...
    """Import Credentials
     ...
     The HTTP POST request to the `/api/v1/automation/credentials/import` endpoint imports credentials to
    Veeam Backup & Replication.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (CredentialsImportSpecCollection): Array of credential import settings.
