...
def _get_kwargs(
    *,
    body: CloudCredentialsImportSpecCollection,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/automation/cloudcredentials/import",
    }
...
def sync_detailed(
    *,
    ...
    """Import Cloud Credentials
     ...
     The HTTP POST request to the `/api/v1/automation/cloudcredentials/import` endpoint imports cloud
    credentials to Veeam Backup & Replication.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (CloudCredentialsImportSpecCollection): Array of settings for cloud credential
            import.
