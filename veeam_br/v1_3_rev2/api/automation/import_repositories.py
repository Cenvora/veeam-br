...
def _get_kwargs(
    *,
    body: RepositoryImportSpecCollection,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/automation/repositories/import",
    }
...
def sync_detailed(
    *,
    ...
    """Import Repositories
     ...
     The HTTP POST request to the `/api/v1/automation/repositories/import` endpoint imports backup
    repositories to Veeam Backup & Replication.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (RepositoryImportSpecCollection): Array of repository import settings.
