...
def _get_kwargs(
    *,
    body: ManageServerImportSpecCollection,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/automation/managedServers/import",
    }
...
def sync_detailed(
    *,
    ...
    """Import Servers
     ...
     The HTTP POST request to the `/api/v1/automation/managedServers/import` endpoint imports managed
    servers to Veeam Backup & Replication.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (ManageServerImportSpecCollection): Array of settings for importing managed servers.
