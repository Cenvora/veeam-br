...
def _get_kwargs(
    *,
    body: EncryptionPasswordImportSpecCollection,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/automation/encryptionPasswords/import",
    }
...
def sync_detailed(
    *,
    ...
    """Import Encryption Passwords
     ...
     The HTTP POST request to the `/api/v1/automation/encryptionPasswords/import` endpoint imports
    encryption passwords to Veeam Backup & Replication.<p>**Available to**&#58; Backup
    Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (EncryptionPasswordImportSpecCollection): Array of import settings for data
