...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/replicaPoints/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Replica Restore Point
     ...
     The HTTP GET request to the `/api/v1/replicaPoints/{id}` endpoint gets a replica restore point that
    has the specified `id`.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also
