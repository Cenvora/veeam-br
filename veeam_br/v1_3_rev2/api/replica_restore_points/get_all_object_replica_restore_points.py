...
def sync_detailed(
    *,
    ...
    """Get All Replica Restore Points
     ...
     The HTTP GET request to the `/api/v1/replicaPoints` endpoint gets an array of all replica restore
    points created on the backup server.<p>**Available to**&#58; Backup Administrator, Restore Operator.
