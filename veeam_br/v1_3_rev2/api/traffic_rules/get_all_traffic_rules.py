...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GlobalNetworkTrafficRulesModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get Traffic Rules
     ...
     The HTTP GET request to the `/api/v1/trafficRules` endpoint gets network traffic rules that control
    traffic transferred between backup infrastructure components.<p>**Available to**&#58; Backup
    Administrator.</p>
