...
def sync_detailed(
    *,
    ...
    """Edit Traffic Rules
     ...
     The HTTP PUT request to the `/api/v1/trafficRules` endpoint edits network traffic rules that are
    configured on the backup server.<p>**Available to**&#58; Backup Administrator.</p>
