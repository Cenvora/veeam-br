...
def sync_detailed(
    ...
    *,
    ...
    deployment kit as a ZIP file. Copy the ZIP file to the target machine, extract its contents and run
    the included configuration script to install the required packages and certificates. <p>**Available
