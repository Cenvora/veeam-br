...
def sync_detailed(
    *,
    ...
    """Get All KMS Servers
     ...
     The HTTP GET request to the `/api/v1/kmsServers` endpoint gets an array of all KMS servers that are
    added to the backup infrastructure.<p>**Available to**&#58; Backup Administrator, Security
    Administrator.</p>
