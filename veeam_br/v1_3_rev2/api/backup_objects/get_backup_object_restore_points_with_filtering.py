...
def sync_detailed(
    ...
    *,
    ...
    restore points of a backup object that has the specified `id`.<p>**Available to**&#58; Backup
    Administrator, Backup Operator, Restore Operator, Backup Viewer. Also available to custom roles that
    have backup or restore permissions.</p>
