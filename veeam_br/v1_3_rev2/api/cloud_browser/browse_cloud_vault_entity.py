...
def sync_detailed(
    ...
    *,
    ...
    """Browse Veeam Data Cloud Vault
     ...
     The HTTP POST request to the `/api/v1/cloudBrowser/{vaultId}` endpoint browses cloud storage
    resources available for the Veeam Data Cloud Vault.<p>**Available to**&#58; Backup
    Administrator.</p>
