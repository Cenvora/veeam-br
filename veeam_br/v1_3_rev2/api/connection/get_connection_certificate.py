...
def sync_detailed(
    *,
    ...
    """Request TLS Certificate or SSH Fingerprint
     ...
     The HTTP POST request to the `/api/v1/connectionCertificate` endpoint gets a TLS certificate or SSH
    fingerprint of the specified host.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (HostConnectionSpec): Connection settings.
