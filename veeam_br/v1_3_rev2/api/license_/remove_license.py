...
from ...models.license_remove_spec import LicenseRemoveSpec
from ...types import Response


def _get_kwargs(
    *,
    body: LicenseRemoveSpec,
...
def sync_detailed(
    *,
    ...
    """Remove License
     ...
     The HTTP POST request to the `/api/v1/license/remove` endpoint removes a license from the backup
    server.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (LicenseRemoveSpec): Remove the license.
