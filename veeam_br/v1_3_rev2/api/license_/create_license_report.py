...
from ...models.license_create_report_spec import LicenseCreateReportSpec
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/license/createReport",
    }
...
def sync_detailed(
    *,
    ...
    for the backup server.<p>**Available to**&#58; Backup Administrator.</p>

    Args:
        x_api_version (str):  Default: '1.3-rev2'.
        body (LicenseCreateReportSpec): Create a report on license usage.
