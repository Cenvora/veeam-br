...
def sync_detailed(
    ...
    *,
    ...
    """Remove Instance License
     ...
     The HTTP POST request to the `/api/v1/license/instances/{instanceId}/remove` endpoint removes a
    licensed Agent instance from the workload that has the specified `instanceId`.<p>**Available
