...
def sync_detailed(
    ...
    *,
    ...
    """Revoke Socket License
     ...
     The HTTP POST request to the `/api/v1/license/sockets/{hostId}/revoke` endpoint revokes a socket
    license from the host with the specified `hostId`.<p>**Available to**&#58; Backup Administrator.</p>
