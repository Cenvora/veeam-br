...
def sync_detailed(
    *,
    ...
    """Enable or Disable Instance Consumption for Unlicensed Agents
     ...
     The HTTP POST request to the `/api/v1/license/agentConsumption` endpoint enables or disables
    unlicensed standalone agents to consume instances.<p>**Available to**&#58; Backup Administrator.</p>
