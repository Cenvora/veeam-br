...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/license/instances/{instance_id}/revoke".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Revoke Instance License
     ...
     The HTTP POST request to the `/api/v1/license/instances/{instanceId}/revoke` endpoint revokes an
    instance license from the workload that has the specified `instanceId`.<p>**Available to**&#58;
