...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/tasks/{id}/stop".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Task
     ...
     The HTTP POST request to the `/api/v1/tasks/{id}/stop` endpoint stops a restore task that has the
    specified `id`.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to
