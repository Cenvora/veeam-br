...
def sync_detailed(
    ...
    *,
    ...
    endpoint gets comparison results for a Microsoft Entra ID Conditional Access policy, initiated by a
    comparison session with the specified `sessionId`.<p>**Available to**&#58; Backup Administrator,
