...
def sync_detailed(
    ...
    *,
    ...
    endpoint checks if the specified Microsoft Entra ID items from a mounted tenant backup are available
    in production.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to
