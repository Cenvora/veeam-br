...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/backupBrowser/flr/unstructuredData/{session_id}/prepareDownload/{task_id}/download".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/flr/unstructuredData/{sessionId}/prepareDownload/{taskId}/download` endpoint
    downloads a ZIP archive with files and folders of a download task that has the specified `taskId`.
