...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupBrowser/entraIdTenant/{backup_id}/uploadRole".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upload Microsoft Entra ID Roles
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/entraIdTenant/{backupId}/uploadRole` endpoint
    uploads a CSV file and gets an array of roles, which is ready to be specified in the body of the
    restore request. The CSV file must contain a list of IDs of Microsoft Entra ID roles.<p>**Available
    ...
    Args:
        ...
        body (File): Comma-separated list of role IDs.
