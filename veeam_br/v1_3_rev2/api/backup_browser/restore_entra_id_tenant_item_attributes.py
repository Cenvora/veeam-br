...
from ...models.entra_id_tenant_restore_item_attributes_spec import EntraIdTenantRestoreItemAttributesSpec
...
def sync_detailed(
    ...
    *,
    ...
    endpoint restores Microsoft Entra ID item properties from a mount point with the specified
    ...
    Args:
        ...
        body (EntraIdTenantRestoreItemAttributesSpec): Restore settings for item properties.
