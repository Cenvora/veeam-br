...
def sync_detailed(
    ...
    *,
    ...
    """Compare Microsoft Entra ID Item Properties
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/entraIdTenant/{sessionId}/compare` endpoint
    compares the properties of a Microsoft Entra ID item available in a mount session that has the
    specified `sessionId`.<p>You can compare item properties either between 2 restore points or between
    a restore point and production. To compare the item to production, do not specify
    ...
    Browser#operation/StartCompareEntraIdTenantItem).</p> <p>**Available to**&#58; Backup Administrator,
