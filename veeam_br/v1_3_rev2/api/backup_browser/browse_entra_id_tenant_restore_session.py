...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/entraIdTenant/{sessionId}/restoreSessions/{restoreSessionId}` endpoint gets a
    restore session that has the specified `restoreSessionId`.<p>**Available to**&#58; Backup
