...
def sync_detailed(
    ...
    *,
    ...
    Policy](Backup-Browser#operation/GetRecursiveComparisonEntraIdTenantItemResult) request.
    </p><p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to custom roles
