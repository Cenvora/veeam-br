...
def sync_detailed(
    ...
    *,
    ...
    Browser#operation/GetCompareEntraIdTenantItemResult) request. For details on synchronous request,
    see [Compare Microsoft Entra ID Item Properties](Backup-
    Browser#operation/CompareEntraIdTenantItem).</p><p>**Available to**&#58; Backup Administrator,
