...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupBrowser/flr/{session_id}/restoreTo".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Restore Files and Folders to Another Location
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/flr/{sessionId}/restoreTo` endpoint restores
    file system items (folders, files and links) to another location.<p>**Available to**&#58; Backup
    ...
    Args:
        ...
        body (FlrRestoreToSpec): Settings for restoring files and folders to another location.
