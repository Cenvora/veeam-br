...
def sync_detailed(
    ...
    *,
    ...
    """Restore Files and Folders to Original Location
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/flr/{sessionId}/restore` endpoint restores file
    system items (folders, files and links) to the original location.<p>**Available to**&#58; Backup
    ...
    Args:
        ...
        body (FlrRestoreSpec): Settings for restoring files and folders to the original location.
