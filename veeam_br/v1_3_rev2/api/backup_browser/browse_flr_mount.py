...
def sync_detailed(
    ...
    *,
    ...
    """Browse File System
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/flr/{sessionId}/browse` endpoint browses file
    system items (drives, folders, files and links) available in a restore session that has the
    specified `sessionId`.<p>You can use this request in the following cases:<li>To browse the file
