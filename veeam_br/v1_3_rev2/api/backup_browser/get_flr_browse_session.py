...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/backupBrowser/flr/{session_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FlrBrowseMountModel.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get File Restore Mount Point
     ...
     The HTTP GET request to the `/api/v1/backupBrowser/flr/{sessionId}` endpoint gets a file restore
    mount point that was created by a restore session that has the specified `sessionId`.<p>**Available
