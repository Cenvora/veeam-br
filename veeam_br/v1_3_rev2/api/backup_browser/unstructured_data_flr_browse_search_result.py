...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/flr/unstructuredData/{sessionId}/search/{taskId}/browse` endpoint browses
    search results of a search task that has the specified `taskId`. <p>**Available to**&#58; Backup
