...
def sync_detailed(
    ...
    *,
    ...
    endpoint allows you to upload a CSV file and get an array of applications, which is ready to be
    specified in the body of the restore request. The CSV file must contain a list of IDs of Microsoft
    Entra ID applications.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also
