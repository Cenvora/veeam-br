...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupBrowser/entraIdTenant/{session_id}/restoreSessions/{restore_session_id}/stop".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/entraIdTenant/{sessionId}/restoreSessions/{restoreSessionId}/stop` endpoint
    stops a restore session of a Microsoft Entra ID tenant.<p>**Available to**&#58; Backup
