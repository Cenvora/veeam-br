...
def sync_detailed(
    ...
    *,
    ...
    """Prepare Files and Folders for Download
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/flr/{sessionId}/prepareDownload` endpoint
    prepares files and folders for download and packs them into a ZIP file. In response, a download task
    is created. <p>To download the ZIP file, specify the task ID in the [Download Files and
    Folders](Backup-Browser#operation/DownloadFlrItem) request. <p>**Available to**&#58; Backup
