...
from ...models.unstructured_data_flr_browse_mount_result import UnstructuredDataFlrBrowseMountResult
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/backupBrowser/flr/unstructuredData",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    specified active unstructured data mount points.<p>**Available to**&#58; Backup Administrator,
