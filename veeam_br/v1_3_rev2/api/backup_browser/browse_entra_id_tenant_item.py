...
def sync_detailed(
    ...
    *,
    ...
    endpoint gets a specific Microsoft Entra ID item available in a tenant backup that has the specified
    `backupId`.<p>**Available to**&#58; Backup Administrator, Restore Operator. Also available to custom
