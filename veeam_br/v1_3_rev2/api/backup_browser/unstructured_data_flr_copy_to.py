...
from ...models.file_backup_flr_copy_to_spec import FileBackupFLRCopyToSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/backupBrowser/flr/unstructuredData/{session_id}/copyTo".format(
...
def sync_detailed(
    ...
    *,
    ...
    endpoint copies file system items (folders, files and links) to the machine where the Veeam Backup &
    Replication console is installed or to a network shared folder.<p>When copying symbolic links, Veeam
    Backup & Replication copies the content that the links point to.</p><p>**Available to**&#58; Backup
    ...
    Args:
        ...
        body (FileBackupFLRCopyToSpec): Settings for copying file system items.
